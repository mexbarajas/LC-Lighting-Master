...
,"7.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">BUG RATING: BACKLIGHT, UPLIGHT, GLARE</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Backlight (B)</text><text x="85" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Light behind fixture</text><text x="85" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Spill onto property</text><text x="85" y="81" text-anchor="middle" font-size="8" fill="#cc3344">Rating B0-B5</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7A9688">B0 = zero backlight</text><rect x="172" y="20" width="154" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="249" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Uplight (U)</text><text x="249" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Light above 90 deg</text><text x="249" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Sky glow driver</text><text x="249" y="81" text-anchor="middle" font-size="8" fill="#1857a0">Rating U0-U5</text><text x="249" y="95" text-anchor="middle" font-size="8" fill="#1857a0">U0 = dark-sky safe</text><rect x="336" y="20" width="176" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="424" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Glare (G)</text><text x="424" y="53" text-anchor="middle" font-size="8" fill="#7A9688">High-angle forward light</text><text x="424" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Discomfort to drivers</text><text x="424" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Rating G0-G5</text><text x="424" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">Lower = less glare</text></svg>`
