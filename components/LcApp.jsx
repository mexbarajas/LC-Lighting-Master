...
,"3.7":`<svg viewBox="0 0 520 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  <rect x="4" y="4" width="252" height="192" rx="10" fill="#e8f5ee" stroke="#2a6048" stroke-width="0.8"/>
  <text x="130" y="24" text-anchor="middle" font-size="10" fill="#2a6048" font-weight="700">LEED</text>
  <text x="130" y="37" text-anchor="middle" font-size="8" fill="#2a6048">Environmental performance</text>
  <rect x="16" y="46" width="108" height="52" rx="6" fill="#fff" stroke="#2a6048" stroke-width="0.5"/>
  <text x="70" y="62" text-anchor="middle" font-size="9" fill="#2a6048" font-weight="600">Energy credits</text>
  <text x="70" y="75" text-anchor="middle" font-size="8" fill="#8a7a6a">LPD reduction</text>
  <text x="70" y="87" text-anchor="middle" font-size="8" fill="#8a7a6a">ASHRAE 90.1</text>
  <rect x="136" y="46" width="108" height="52" rx="6" fill="#fff" stroke="#2a6048" stroke-width="0.5"/>
  <text x="190" y="62" text-anchor="middle" font-size="9" fill="#2a6048" font-weight="600">Controls</text>
  <text x="190" y="75" text-anchor="middle" font-size="8" fill="#8a7a6a">Daylight harvest</text>
  <text x="190" y="87" text-anchor="middle" font-size="8" fill="#8a7a6a">Occupancy sensors</text>
  <rect x="16" y="106" width="108" height="52" rx="6" fill="#fff" stroke="#2a6048" stroke-width="0.5"/>
  <text x="70" y="122" text-anchor="middle" font-size="9" fill="#2a6048" font-weight="600">EQ credits</text>
  <text x="70" y="135" text-anchor="middle" font-size="8" fill="#8a7a6a">Daylight + views</text>
  <text x="70" y="147" text-anchor="middle" font-size="8" fill="#8a7a6a">Glare control</text>
  <rect x="136" y="106" width="108" height="52" rx="6" fill="#fff" stroke="#2a6048" stroke-width="0.5"/>
  <text x="190" y="122" text-anchor="middle" font-size="9" fill="#2a6048" font-weight="600">Quality</text>
  <text x="190" y="135" text-anchor="middle" font-size="8" fill="#8a7a6a">CRI ≥ 90, R9 ≥ 50</text>
  <text x="190" y="147" text-anchor="middle" font-size="8" fill="#8a7a6a">LEED v4.1 EQ</text>
  <rect x="16" y="166" width="228" height="22" rx="5" fill="#2a6048" opacity="0.12"/>
  <text x="130" y="181" text-anchor="middle" font-size="9" fill="#2a6048" font-weight="600">Metric: watts per sq ft — light as energy</text>
  <text x="266" y="104" text-anchor="middle" font-size="11" fill="#8a7a6a" font-weight="700">vs</text>
  ...
  <text x="330" y="75" text-anchor="middle" font-size="8" fill="#8a7a6a">≥200 EML target</text>
  <text x="330" y="87" text-anchor="middle" font-size="8" fill="#8a7a6a">Tunable white</text>
  ...
  <text x="450" y="75" text-anchor="middle" font-size="8" fill="#8a7a6a">UGR glare limits</text>
  <text x="450" y="87" text-anchor="middle" font-size="8" fill="#8a7a6a">Luminance ratios</text>
  ...
  <text x="330" y="135" text-anchor="middle" font-size="8" fill="#8a7a6a">Flicker reduction</text>
  <text x="330" y="147" text-anchor="middle" font-size="8" fill="#8a7a6a">CRI ≥ 90, R9 ≥ 50</text>
  ...
  <text x="450" y="135" text-anchor="middle" font-size="8" fill="#8a7a6a">sDA / ASE metrics</text>
  <text x="450" y="147" text-anchor="middle" font-size="8" fill="#8a7a6a">View quality</text>
