...
const LC_VISUALS = {
"1.1":`<svg viewBox="0 0 520 120" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><defs><linearGradient id="sp1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#7B00FF"/><stop offset="20%" stop-color="#0044FF"/><stop offset="40%" stop-color="#00AAFF"/><stop offset="58%" stop-color="#00EE44"/><stop offset="74%" stop-color="#AAFF00"/><stop offset="86%" stop-color="#FFAA00"/><stop offset="100%" stop-color="#FF2200"/></linearGradient></defs><rect x="8" y="28" width="60" height="16" rx="3" fill="#f0ece4"/><text x="38" y="22" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">RADIO/UV</text><rect x="68" y="20" width="380" height="30" rx="4" fill="url(#sp1)"/><text x="258" y="14" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".08em">VISIBLE SPECTRUM  380–780 nm</text><rect x="448" y="28" width="60" height="16" rx="3" fill="#FF4400" opacity=".18"/><text x="478" y="22" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">INFRARED</text><line x1="68" y1="50" x2="68" y2="60" stroke="#C8B8A4" stroke-width=".7"/><text x="68" y="69" text-anchor="middle" font-size="8" fill="#3D5C50">380 nm</text><text x="68" y="79" text-anchor="middle" font-size="9" fill="#7B00FF">Violet</text><line x1="168" y1="50" x2="168" y2="60" stroke="#C8B8A4" stroke-width=".7"/><text x="168" y="69" text-anchor="middle" font-size="8" fill="#3D5C50">480 nm</text><text x="168" y="79" text-anchor="middle" font-size="9" fill="#0088FF">ipRGC</text><line x1="232" y1="50" x2="232" y2="60" stroke="#C8B8A4" stroke-width=".7"/><text x="232" y="69" text-anchor="middle" font-size="8" fill="#3D5C50">507 nm</text><text x="232" y="79" text-anchor="middle" font-size="9" fill="#00AA44">Rod peak</text><line x1="316" y1="50" x2="316" y2="60" stroke="#C8B8A4" stroke-width=".7"/><text x="316" y="69" text-anchor="middle" font-size="8" fill="#3D5C50">555 nm</text><text x="316" y="79" text-anchor="middle" font-size="9" fill="#88AA00">Cone peak</text><line x1="448" y1="50" x2="448" y2="60" stroke="#C8B8A4" stroke-width=".7"/><text x="448" y="69" text-anchor="middle" font-size="8" fill="#3D5C50">780 nm</text><text x="258" y="104" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Wavelength determines colour · SPD is the fingerprint of every light source</text><text x="258" y="116" text-anchor="middle" font-size="9" fill="#7A9688">CCT · CRI · TM-30 · Melanopic lux — all derived from the SPD</text></svg>`,
"1.2":`<svg viewBox="0 0 520 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><defs><marker id="ar1" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L6,3z" fill="#7A9688"/></marker></defs><rect x="8" y="18" width="108" height="66" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="62" y="36" text-anchor="middle" font-size="10" fill="#C65A3A" font-family="monospace" font-weight="500">Φ FLUX</text><text x="62" y="49" text-anchor="middle" font-size="9" fill="#2F4A3F">Lumens (lm)</text><text x="62" y="62" text-anchor="middle" font-size="8" fill="#7A9688">Total output</text><text x="62" y="74" text-anchor="middle" font-size="8" fill="#7A9688">all directions</text><line x1="116" y1="51" x2="134" y2="51" stroke="#7A9688" stroke-width="1" marker-end="url(#ar1)"/><rect x="136" y="18" width="108" height="66" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="190" y="36" text-anchor="middle" font-size="10" fill="#7E9B86" font-family="monospace" font-weight="500">I INTENSITY</text><text x="190" y="49" text-anchor="middle" font-size="9" fill="#2F4A3F">Candelas (cd)</text><text x="190" y="62" text-anchor="middle" font-size="8" fill="#7A9688">Directional</text><text x="190" y="74" text-anchor="middle" font-size="8" fill="#7A9688">beam intensity</text><line x1="244" y1="51" x2="262" y2="51" stroke="#7A9688" stroke-width="1" marker-end="url(#ar1)"/><rect x="264" y="18" width="108" height="66" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="318" y="36" text-anchor="middle" font-size="10" fill="#1857a0" font-family="monospace" font-weight="500">E ILLUM.</text><text x="318" y="49" text-anchor="middle" font-size="9" fill="#2F4A3F">Lux / fc</text><text x="318" y="62" text-anchor="middle" font-size="8" fill="#7A9688">Flux per</text><text x="318" y="74" text-anchor="middle" font-size="8" fill="#7A9688">unit area</text><line x1="372" y1="51" x2="390" y2="51" stroke="#7A9688" stroke-width="1" marker-end="url(#ar1)"/><rect x="392" y="18" width="120" height="66" rx="5" fill="#f3eef8" stroke="#7a3a9a" stroke-width=".8"/><text x="452" y="36" text-anchor="middle" font-size="10" fill="#7a3a9a" font-family="monospace" font-weight="500">L LUMIN.</text><text x="452" y="49" text-anchor="middle" font-size="9" fill="#2F4A3F">cd / m²</text><text x="452" y="62" text-anchor="middle" font-size="8" fill="#7a3a9a">Perceived</text><text x="452" y="74" text-anchor="middle" font-size="8" fill="#7a3a9a">causes glare</text><text x="62" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Integ. sphere</text><text x="190" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Goniophotometer</text><text x="318" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Illum. meter</text><text x="452" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Luminance cam.</text><text x="260" y="120" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">E = I / d²  ·  double distance → ¼ illuminance  ·  1 fc = 10.76 lux</text></svg>`,
"1.3":`<svg viewBox="0 0 520 140" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><line x1="36" y1="14" x2="36" y2="112" stroke="#DDD0C0" stroke-width=".8"/><line x1="36" y1="112" x2="500" y2="112" stroke="#DDD0C0" stroke-width=".8"/><text x="32" y="18" text-anchor="end" font-size="9" fill="#7A9688">100%</text><text x="32" y="63" text-anchor="end" font-size="9" fill="#7A9688">50%</text><polyline points="55,110 95,107 136,95 162,66 182,38 200,20 218,38 240,66 272,95 314,107 365,110" fill="none" stroke="#1857a0" stroke-width="1.5" stroke-dasharray="5,3" opacity=".75"/><polyline points="66,110 106,106 148,93 174,62 196,35 214,18 232,35 256,62 290,93 336,106 384,110" fill="none" stroke="#7E9B86" stroke-width="2"/><polyline points="82,110 126,105 166,84 208,52 246,26 272,13 302,26 342,52 386,84 430,105 476,110" fill="none" stroke="#C65A3A" stroke-width="2.5"/><line x1="200" y1="20" x2="200" y2="112" stroke="#1857a0" stroke-width=".6" stroke-dasharray="3,4" opacity=".6"/><line x1="214" y1="18" x2="214" y2="112" stroke="#7E9B86" stroke-width=".6" stroke-dasharray="3,4"/><line x1="272" y1="13" x2="272" y2="112" stroke="#C65A3A" stroke-width=".6" stroke-dasharray="3,4"/><text x="140" y="124" text-anchor="middle" font-size="8" fill="#7A9688">400</text><text x="200" y="124" text-anchor="middle" font-size="8" fill="#1857a0">480</text><text x="236" y="124" text-anchor="middle" font-size="8" fill="#7E9B86">507</text><text x="272" y="124" text-anchor="middle" font-size="8" fill="#C65A3A">555</text><text x="410" y="124" text-anchor="middle" font-size="8" fill="#7A9688">700nm</text><rect x="356" y="16" width="8" height="8" rx="2" fill="#C65A3A"/><text x="368" y="23" font-size="9" fill="#2F4A3F">Photopic cones 555nm</text><rect x="356" y="30" width="8" height="8" rx="2" fill="#7E9B86"/><text x="368" y="37" font-size="9" fill="#2F4A3F">Scotopic rods 507nm</text><rect x="356" y="44" width="8" height="8" rx="2" fill="#1857a0" opacity=".75"/><text x="368" y="51" font-size="9" fill="#2F4A3F">ipRGC melanopsin 480nm</text><text x="258" y="138" text-anchor="middle" font-size="9" fill="#7A9688">Three separate receptor systems — each drives different responses</text></svg>`,
"1.4":`<svg viewBox="0 0 520 128" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><defs><linearGradient id="cg1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#FF9020"/><stop offset="30%" stop-color="#FFD888"/><stop offset="55%" stop-color="#FFFAF4"/><stop offset="80%" stop-color="#EEF2FF"/><stop offset="100%" stop-color="#BBCCFF"/></linearGradient></defs><text x="16" y="16" font-size="8" fill="#C65A3A" font-weight="500">◀ Warm</text><text x="504" y="16" text-anchor="end" font-size="8" fill="#4455bb" font-weight="500">Cool ▶</text><rect x="16" y="20" width="488" height="28" rx="4" fill="url(#cg1)" stroke="#DDD0C0" stroke-width=".5"/><line x1="16" y1="48" x2="16" y2="58" stroke="#C8B8A4" stroke-width=".7"/><text x="16" y="66" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">1900K</text><text x="16" y="76" text-anchor="middle" font-size="9" fill="#7A9688">Candle</text><line x1="82" y1="48" x2="82" y2="58" stroke="#C8B8A4" stroke-width=".7"/><text x="82" y="66" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">2700K</text><text x="82" y="76" text-anchor="middle" font-size="9" fill="#7A9688">Incandescent</text><line x1="192" y1="48" x2="192" y2="58" stroke="#C8B8A4" stroke-width=".7"/><text x="192" y="66" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">3500K</text><text x="192" y="76" text-anchor="middle" font-size="9" fill="#7A9688">Neutral</text><line x1="288" y1="48" x2="288" y2="58" stroke="#C8B8A4" stroke-width=".7"/><text x="288" y="66" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">4000K</text><text x="192" y="89" text-anchor="middle" font-size="9" fill="#7A9688">Cool white</text><line x1="414" y1="48" x2="414" y2="58" stroke="#C8B8A4" stroke-width=".7"/><text x="414" y="66" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">5800K</text><text x="414" y="76" text-anchor="middle" font-size="9" fill="#7A9688">Noon daylight</text><line x1="504" y1="48" x2="504" y2="58" stroke="#C8B8A4" stroke-width=".7"/><text x="504" y="66" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace">6500K</text><text x="504" y="76" text-anchor="middle" font-size="9" fill="#7A9688">Overcast</text><rect x="16" y="90" width="142" height="34" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".7"/><text x="87" y="106" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">2700–3000K</text><text x="87" y="118" text-anchor="middle" font-size="8" fill="#7A9688">Restaurant · Home</text><rect x="168" y="90" width="178" height="34" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".7"/><text x="257" y="106" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">3500–4000K</text><text x="257" y="118" text-anchor="middle" font-size="8" fill="#7A9688">Office · School · Retail</text><rect x="356" y="90" width="162" height="34" rx="4" fill="#eef0ff" stroke="#4455bb" stroke-width=".7"/><text x="437" y="106" text-anchor="middle" font-size="9" fill="#4455bb" font-weight="500">5000–6500K</text><text x="437" y="118" text-anchor="middle" font-size="8" fill="#7A9688">Healthcare · Lab</text></svg>`,
"1.5":`<svg viewBox="0 0 520 155" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><rect x="8" y="8" width="228" height="139" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="122" y="26" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="600">CRI scale (Ra)</text><rect x="20" y="33" width="200" height="16" rx="2" fill="#7E9B86"/><text x="28" y="45" text-anchor="start" font-size="9" fill="#FAF5F0" font-weight="700">Ra 100 — perfect</text><rect x="20" y="53" width="174" height="16" rx="2" fill="#7E9B86" opacity=".75"/><text x="28" y="65" text-anchor="start" font-size="9" fill="#FAF5F0" font-weight="700">Ra 90 — excellent</text><rect x="20" y="73" width="148" height="16" rx="2" fill="#C65A3A" opacity=".9"/><text x="28" y="85" text-anchor="start" font-size="9" fill="#FAF5F0" font-weight="700">Ra 80 — good</text><rect x="20" y="93" width="118" height="16" rx="2" fill="#e8a020"/><text x="28" y="105" text-anchor="start" font-size="9" fill="#2F4A3F" font-weight="700">Ra 70 — acceptable</text><rect x="20" y="113" width="80" height="16" rx="2" fill="#cc4444" opacity=".8"/><text x="28" y="125" text-anchor="start" font-size="9" fill="#FAF5F0" font-weight="700">Ra 60 — poor</text><rect x="20" y="133" width="200" height="18" rx="3" fill="#C65A3A" opacity=".1" stroke="#C65A3A" stroke-width=".8"/><text x="120" y="145" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="600">R9 NOT in Ra — specify ≥50 separately</text><rect x="248" y="8" width="264" height="139" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="380" y="26" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="600">TM-30 — two metrics</text><rect x="260" y="34" width="112" height="52" rx="4" fill="#fff" stroke="#7E9B86" stroke-width="1"/><text x="316" y="56" text-anchor="middle" font-size="16" fill="#7E9B86" font-weight="700">Rf</text><text x="316" y="68" text-anchor="middle" font-size="8" fill="#7A9688">Fidelity · 99 samples</text><text x="316" y="79" text-anchor="middle" font-size="8" fill="#7E9B86">0–100 like CRI</text><rect x="382" y="34" width="120" height="52" rx="4" fill="#fff" stroke="#C65A3A" stroke-width="1"/><text x="442" y="56" text-anchor="middle" font-size="16" fill="#C65A3A" font-weight="700">Rg</text><text x="442" y="68" text-anchor="middle" font-size="8" fill="#7A9688">Gamut index</text><text x="442" y="79" text-anchor="middle" font-size="8" fill="#C65A3A">&gt;100 vivid · &lt;100 flat</text><rect x="260" y="94" width="112" height="46" rx="4" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".5"/><text x="316" y="112" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="600">Museum / Hospital</text><text x="316" y="126" text-anchor="middle" font-size="9" fill="#7A9688">Rf ≥90 · Rg ~100</text><rect x="382" y="94" width="120" height="46" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".5"/><text x="442" y="112" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="600">Grocery / Fashion</text><text x="442" y="126" text-anchor="middle" font-size="9" fill="#7A9688">Rf ≥85 · Rg &gt;105</text></svg>`,
"1.6":`<svg viewBox="0 0 520 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">COMPLETE COLOUR RENDERING SPECIFICATION</text><rect x="8" y="18" width="112" height="84" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width="1"/><text x="64" y="36" text-anchor="middle" font-size="9" fill="#C65A3A" font-family="monospace" font-weight="500">CCT</text><text x="64" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Appearance</text><text x="64" y="63" text-anchor="middle" font-size="8" fill="#7A9688">2700K warm</text><text x="64" y="75" text-anchor="middle" font-size="8" fill="#7A9688">4000K neutral</text><text x="64" y="87" text-anchor="middle" font-size="8" fill="#7A9688">6500K cool</text><text x="124" y="64" text-anchor="middle" font-size="15" fill="#7A9688" opacity=".35">+</text><rect x="130" y="18" width="112" height="84" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width="1"/><text x="186" y="36" text-anchor="middle" font-size="9" fill="#7E9B86" font-family="monospace" font-weight="500">Min Ra</text><text x="186" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Colour fidelity</text><text x="186" y="63" text-anchor="middle" font-size="8" fill="#7A9688">≥70 industrial</text><text x="186" y="75" text-anchor="middle" font-size="8" fill="#7A9688">≥80 offices</text><text x="186" y="87" text-anchor="middle" font-size="8" fill="#7E9B86" font-weight="500">≥90 critical</text><text x="246" y="64" text-anchor="middle" font-size="15" fill="#7A9688" opacity=".35">+</text><rect x="252" y="18" width="112" height="84" rx="5" fill="#ffeef0" stroke="#cc3344" stroke-width="1"/><text x="308" y="36" text-anchor="middle" font-size="9" fill="#cc3344" font-family="monospace" font-weight="500">Min R9</text><text x="308" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Saturated red</text><text x="308" y="63" text-anchor="middle" font-size="8" fill="#7A9688">NOT in Ra</text><text x="308" y="75" text-anchor="middle" font-size="8" fill="#cc3344" font-weight="500">Specify ≥ 50</text><text x="308" y="87" text-anchor="middle" font-size="8" fill="#7A9688">retail/health</text><text x="368" y="64" text-anchor="middle" font-size="15" fill="#7A9688" opacity=".35">+</text><rect x="374" y="18" width="138" height="84" rx="5" fill="#eef0ff" stroke="#4455bb" stroke-width="1"/><text x="443" y="36" text-anchor="middle" font-size="9" fill="#4455bb" font-family="monospace" font-weight="500">SDCM</text><text x="443" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Consistency</text><text x="443" y="63" text-anchor="middle" font-size="8" fill="#4455bb" font-weight="500">≤ 3-step</text><text x="443" y="75" text-anchor="middle" font-size="8" fill="#7A9688">adjacent fixtures</text><text x="443" y="87" text-anchor="middle" font-size="8" fill="#7A9688">look identical</text><rect x="8" y="108" width="504" height="18" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="121" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">None alone is sufficient — always specify all four together</text></svg>`,
"2.1":`<svg viewBox="0 0 520 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">FLUORESCENT LAMP — HOW IT WORKS</text><rect x="28" y="20" width="464" height="36" rx="18" fill="none" stroke="#DDD0C0" stroke-width="1.5"/><rect x="34" y="26" width="452" height="24" rx="12" fill="#e8eef8" opacity=".5"/><text x="260" y="42" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Mercury vapour discharge tube — low pressure</text><circle cx="28" cy="38" r="9" fill="#e8eef8" stroke="#1857a0" stroke-width="1"/><circle cx="492" cy="38" r="9" fill="#e8eef8" stroke="#1857a0" stroke-width="1"/><text x="260" y="72" text-anchor="middle" font-size="8" fill="#7A9688">↓  Mercury discharge emits UV at 254 nm  ↓</text><rect x="28" y="80" width="464" height="18" rx="3" fill="#C65A3A" opacity=".12" stroke="#C65A3A" stroke-width=".6"/><text x="260" y="93" text-anchor="middle" font-size="8" fill="#C65A3A" font-weight="500">Phosphor coating converts UV → visible light (CCT &amp; CRI set by phosphor mix)</text><rect x="68" y="108" width="96" height="16" rx="3" fill="#FFD080" opacity=".8"/><text x="116" y="120" text-anchor="middle" font-size="8" fill="#7a5a00">2700K warm</text><rect x="212" y="108" width="96" height="16" rx="3" fill="#FFFAF4" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="120" text-anchor="middle" font-size="8" fill="#7A9688">4000K neutral</text><rect x="356" y="108" width="96" height="16" rx="3" fill="#E8EEFF"/><text x="404" y="120" text-anchor="middle" font-size="8" fill="#4455bb">6500K cool</text></svg>`,
"2.2":`<svg viewBox="0 0 520 138" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">MAGNETIC vs ELECTRONIC BALLAST</text><rect x="8" y="18" width="242" height="112" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="36" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Magnetic ballast</text><text x="129" y="51" text-anchor="middle" font-size="9" fill="#7A9688">Operates at 50 / 60 Hz</text><text x="129" y="65" text-anchor="middle" font-size="9" fill="#cc3344">100 / 120 Hz flicker</text><text x="129" y="79" text-anchor="middle" font-size="9" fill="#cc3344">Stroboscopic on machinery</text><text x="129" y="93" text-anchor="middle" font-size="9" fill="#7A9688">Heavy · inefficient</text><text x="129" y="107" text-anchor="middle" font-size="9" fill="#7A9688">Cannot dim smoothly</text><text x="129" y="121" text-anchor="middle" font-size="8" fill="#7A9688">~15% efficacy penalty</text><rect x="270" y="18" width="242" height="112" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="36" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">Electronic ballast</text><text x="391" y="51" text-anchor="middle" font-size="9" fill="#7A9688">Operates at 20k–50k Hz</text><text x="391" y="65" text-anchor="middle" font-size="9" fill="#7E9B86">No perceptible flicker</text><text x="391" y="79" text-anchor="middle" font-size="9" fill="#7E9B86">10–30% more efficient</text><text x="391" y="93" text-anchor="middle" font-size="9" fill="#7A9688">Compact · lighter</text><text x="391" y="107" text-anchor="middle" font-size="9" fill="#7E9B86">Dimmable (0–10V/DALI)</text><text x="391" y="121" text-anchor="middle" font-size="8" fill="#7A9688">Longer lamp life</text></svg>`,
"2.3":`<svg viewBox="0 0 520 138" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">THREE LED RETROFIT PATHS</text><rect x="8" y="18" width="154" height="112" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="35" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Path 1 — Type A</text><text x="85" y="49" text-anchor="middle" font-size="8" fill="#C65A3A" font-weight="500">Lamp swap only</text><text x="85" y="63" text-anchor="middle" font-size="8" fill="#7A9688">LED tube into</text><text x="85" y="75" text-anchor="middle" font-size="8" fill="#7A9688">existing ballast</text><text x="85" y="87" text-anchor="middle" font-size="8" fill="#7A9688">No electrical work</text><text x="85" y="99" text-anchor="middle" font-size="8" fill="#cc3344">Limited by ballast</text><text x="85" y="121" text-anchor="middle" font-size="8" fill="#7A9688">Lowest first cost</text><rect x="182" y="18" width="154" height="112" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="259" y="35" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Path 2 — Type B</text><text x="259" y="49" text-anchor="middle" font-size="8" fill="#1857a0" font-weight="500">Ballast bypass</text><text x="259" y="63" text-anchor="middle" font-size="8" fill="#7A9688">Remove ballast</text><text x="259" y="75" text-anchor="middle" font-size="8" fill="#7A9688">Wire direct to mains</text><text x="259" y="87" text-anchor="middle" font-size="8" fill="#7A9688">Needs electrician</text><text x="259" y="99" text-anchor="middle" font-size="8" fill="#7E9B86">No ballast failure</text><text x="259" y="121" text-anchor="middle" font-size="8" fill="#7A9688">Medium first cost</text><rect x="356" y="18" width="156" height="112" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="434" y="35" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Path 3 — Type C</text><text x="434" y="49" text-anchor="middle" font-size="8" fill="#7E9B86" font-weight="500">Full fixture replace</text><text x="434" y="63" text-anchor="middle" font-size="8" fill="#7A9688">New complete LED</text><text x="434" y="75" text-anchor="middle" font-size="8" fill="#7E9B86">Best photometrics</text><text x="434" y="87" text-anchor="middle" font-size="8" fill="#7E9B86">DLC rebate eligible</text><text x="434" y="99" text-anchor="middle" font-size="8" fill="#7E9B86">Best 10-yr TCO</text><text x="434" y="121" text-anchor="middle" font-size="8" fill="#7A9688">Highest first cost</text></svg>`,
"2.4":`<svg viewBox="0 0 520 138" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">HID LAMP TYPES COMPARED</text><rect x="8" y="18" width="154" height="112" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="35" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">High-Pressure Sodium</text><text x="85" y="48" text-anchor="middle" font-size="8" fill="#C65A3A" font-weight="500">HPS (SON)</text><text x="85" y="62" text-anchor="middle" font-size="8" fill="#7A9688">CCT 2000–2500K</text><text x="85" y="75" text-anchor="middle" font-size="8" fill="#cc3344">Ra 10–80 poor</text><text x="85" y="88" text-anchor="middle" font-size="8" fill="#7E9B86">50–130 lm/W</text><text x="85" y="101" text-anchor="middle" font-size="8" fill="#7A9688">Amber-yellow</text><text x="85" y="121" text-anchor="middle" font-size="8" fill="#cc3344">10–20 min restrike</text><rect x="182" y="18" width="154" height="112" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="259" y="35" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Metal Halide</text><text x="259" y="48" text-anchor="middle" font-size="8" fill="#1857a0" font-weight="500">MH / CMH</text><text x="259" y="62" text-anchor="middle" font-size="8" fill="#7A9688">CCT 3000–5600K</text><text x="259" y="75" text-anchor="middle" font-size="8" fill="#7E9B86">Ra 65–95 good</text><text x="259" y="88" text-anchor="middle" font-size="8" fill="#7E9B86">75–140 lm/W</text><text x="259" y="101" text-anchor="middle" font-size="8" fill="#7A9688">Neutral-cool white</text><text x="259" y="121" text-anchor="middle" font-size="8" fill="#cc3344">10–20 min restrike</text><rect x="356" y="18" width="156" height="112" rx="5" fill="#fff8ee" stroke="#C65A3A" stroke-width=".8"/><text x="434" y="35" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Compact Fluor.</text><text x="434" y="48" text-anchor="middle" font-size="8" fill="#C65A3A" font-weight="500">CFL</text><text x="434" y="62" text-anchor="middle" font-size="8" fill="#7A9688">CCT 2700–6500K</text><text x="434" y="75" text-anchor="middle" font-size="8" fill="#7A9688">Ra ~80</text><text x="434" y="88" text-anchor="middle" font-size="8" fill="#7A9688">50–85 lm/W</text><text x="434" y="101" text-anchor="middle" font-size="8" fill="#cc3344">1–3 min warm-up</text><text x="434" y="121" text-anchor="middle" font-size="8" fill="#cc3344">Mercury disposal</text></svg>`,
"2.5":`<svg viewBox="0 0 520 138" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LUMINOUS EFFICACY — lm/W AT LUMINAIRE LEVEL</text><line x1="120" y1="18" x2="120" y2="118" stroke="#DDD0C0" stroke-width=".8"/><line x1="120" y1="118" x2="510" y2="118" stroke="#DDD0C0" stroke-width=".8"/><text x="116" y="22" text-anchor="end" font-size="9" fill="#7A9688">170</text><text x="116" y="52" text-anchor="end" font-size="9" fill="#7A9688">130</text><text x="116" y="82" text-anchor="end" font-size="9" fill="#7A9688">80</text><text x="116" y="112" text-anchor="end" font-size="9" fill="#7A9688">15</text><rect x="138" y="104" width="36" height="14" rx="2" fill="#cc3344" opacity=".7"/><text x="156" y="128" text-anchor="middle" font-size="9" fill="#7A9688">Incand.</text><rect x="192" y="72" width="36" height="46" rx="2" fill="#e8a020" opacity=".8"/><text x="210" y="128" text-anchor="middle" font-size="9" fill="#7A9688">CFL</text><rect x="246" y="56" width="36" height="62" rx="2" fill="#C65A3A" opacity=".8"/><text x="264" y="128" text-anchor="middle" font-size="9" fill="#7A9688">T8 Fl.</text><rect x="300" y="50" width="36" height="68" rx="2" fill="#1857a0" opacity=".8"/><text x="318" y="128" text-anchor="middle" font-size="9" fill="#7A9688">HPS</text><rect x="354" y="42" width="36" height="76" rx="2" fill="#7a3a9a" opacity=".8"/><text x="372" y="128" text-anchor="middle" font-size="9" fill="#7A9688">Metal H.</text><rect x="408" y="18" width="36" height="100" rx="2" fill="#7E9B86"/><text x="426" y="128" text-anchor="middle" font-size="9" fill="#7A9688">LED</text><text x="156" y="101" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="600">15</text><text x="210" y="69" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="600">68</text><text x="264" y="53" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="600">85</text><text x="318" y="47" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="600">105</text><text x="372" y="39" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="600">120</text><text x="426" y="15" text-anchor="middle" font-size="8" fill="#7E9B86" font-weight="500">150+</text><text x="260" y="138" text-anchor="middle" font-size="8" fill="#7A9688">Always compare at luminaire level — not bare lamp efficacy</text></svg>`,
"2.6":`<svg viewBox="0 0 520 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">SOURCE SELECTION DECISION FRAMEWORK</text><rect x="8" y="18" width="504" height="28" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="30" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Step 1 — Hard constraint filter</text><text x="260" y="41" text-anchor="middle" font-size="8" fill="#7A9688">Ra requirement · Instant restrike · Cold temperature · Dimmability required</text><text x="260" y="58" text-anchor="middle" font-size="16" fill="#7A9688" opacity=".3">↓</text><rect x="8" y="62" width="504" height="28" rx="4" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="260" y="74" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Step 2 — Compare remaining options on 10-year TCO</text><text x="260" y="85" text-anchor="middle" font-size="8" fill="#7A9688">First cost + PV(energy) + PV(maintenance) + disposal</text><text x="260" y="102" text-anchor="middle" font-size="16" fill="#7A9688" opacity=".3">↓</text><rect x="8" y="106" width="504" height="22" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="121" text-anchor="middle" font-size="8" fill="#2F4A3F" font-weight="500">Traps: HID + instant restrike · Lamp efficacy for LPD calc · Low-CRI for colour-critical task</text></svg>`,
"3.1":`<svg viewBox="0 0 520 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">P-N JUNCTION — LED LIGHT EMISSION</text><rect x="40" y="20" width="180" height="80" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="130" y="42" text-anchor="middle" font-size="11" fill="#1857a0" font-weight="500">N-type</text><text x="130" y="57" text-anchor="middle" font-size="9" fill="#7A9688">Free electrons (−)</text><text x="130" y="70" text-anchor="middle" font-size="8" fill="#7A9688">e⁻  e⁻  e⁻  e⁻</text><text x="130" y="83" text-anchor="middle" font-size="8" fill="#7A9688">Donor atoms doped in</text><rect x="300" y="20" width="180" height="80" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="390" y="42" text-anchor="middle" font-size="11" fill="#C65A3A" font-weight="500">P-type</text><text x="390" y="57" text-anchor="middle" font-size="9" fill="#7A9688">Holes (+)</text><text x="390" y="70" text-anchor="middle" font-size="8" fill="#7A9688">○  ○  ○  ○</text><text x="390" y="83" text-anchor="middle" font-size="8" fill="#7A9688">Acceptor atoms doped in</text><line x1="220" y1="60" x2="300" y2="60" stroke="#DDD0C0" stroke-width="1.5" stroke-dasharray="4,3"/><text x="260" y="56" text-anchor="middle" font-size="8" fill="#7A9688">Junction</text><text x="260" y="74" text-anchor="middle" font-size="18" fill="#C65A3A">→</text><circle cx="260" cy="60" r="16" fill="#FFD700" opacity=".3" stroke="#FFD700" stroke-width="1"/><text x="260" y="64" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">hν</text><text x="260" y="106" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Electron falls from N to P → releases photon (hν)</text><text x="260" y="120" text-anchor="middle" font-size="8" fill="#7A9688">Bandgap energy determines wavelength · Bandgap determines colour</text></svg>`,
"3.2":`<svg viewBox="0 0 520 128" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">FOUR PARTS OF A LUMINAIRE</text><rect x="8" y="18" width="114" height="90" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width="1"/><text x="65" y="36" text-anchor="middle" font-size="8" fill="#C65A3A" font-family="monospace" font-weight="500">① LED SOURCE</text><text x="65" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Package / module</text><text x="65" y="63" text-anchor="middle" font-size="8" fill="#7A9688">Generates photons</text><text x="65" y="76" text-anchor="middle" font-size="8" fill="#7A9688">Bandgap sets colour</text><text x="65" y="100" text-anchor="middle" font-size="8" fill="#C65A3A">Tested: LM-79</text><rect x="134" y="18" width="114" height="90" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width="1"/><text x="191" y="36" text-anchor="middle" font-size="8" fill="#1857a0" font-family="monospace" font-weight="500">② DRIVER</text><text x="191" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">AC → DC converter</text><text x="191" y="63" text-anchor="middle" font-size="8" fill="#7A9688">Controls current</text><text x="191" y="76" text-anchor="middle" font-size="8" fill="#7A9688">Handles dimming</text><text x="191" y="100" text-anchor="middle" font-size="8" fill="#cc3344">Top failure cause</text><rect x="260" y="18" width="114" height="90" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width="1"/><text x="317" y="36" text-anchor="middle" font-size="8" fill="#7E9B86" font-family="monospace" font-weight="500">③ THERMAL</text><text x="317" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Heat sink + TIM</text><text x="317" y="63" text-anchor="middle" font-size="8" fill="#7A9688">Junction→ambient</text><text x="317" y="76" text-anchor="middle" font-size="8" fill="#7A9688">path critical</text><text x="317" y="100" text-anchor="middle" font-size="8" fill="#7E9B86">Tested: LM-80</text><rect x="386" y="18" width="126" height="90" rx="5" fill="#f3eef8" stroke="#7a3a9a" stroke-width="1"/><text x="449" y="36" text-anchor="middle" font-size="8" fill="#7a3a9a" font-family="monospace" font-weight="500">④ OPTICS</text><text x="449" y="50" text-anchor="middle" font-size="8" fill="#2F4A3F">Lens/reflector</text><text x="449" y="63" text-anchor="middle" font-size="8" fill="#7A9688">Diffuser / baffle</text><text x="449" y="76" text-anchor="middle" font-size="8" fill="#7A9688">Shapes distribution</text><text x="449" y="100" text-anchor="middle" font-size="8" fill="#7a3a9a">IES file output</text><text x="260" y="120" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">All four must be tested together as a system — LM-79 on complete luminaire</text></svg>`,
"3.3":`<svg viewBox="0 0 520 128" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">THERMAL PATH — LED JUNCTION TO AMBIENT AIR</text><rect x="8" y="20" width="504" height="26" rx="3" fill="#C65A3A" opacity=".15" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="37" text-anchor="middle" font-size="10" fill="#C65A3A" font-weight="500">LED Junction (highest temp — target ≤85°C)</text><text x="260" y="55" text-anchor="middle" font-size="10" fill="#7A9688">↓  conduction  ↓</text><rect x="8" y="60" width="504" height="16" rx="3" fill="#e8a020" opacity=".2" stroke="#e8a020" stroke-width=".6"/><text x="260" y="72" text-anchor="middle" font-size="8" fill="#7a5a00">Solder pad → MCPCB (metal-core PCB)</text><text x="260" y="85" text-anchor="middle" font-size="10" fill="#7A9688">↓  TIM (thermal interface material)  ↓</text><rect x="8" y="90" width="504" height="16" rx="3" fill="#7E9B86" opacity=".15" stroke="#7E9B86" stroke-width=".6"/><text x="260" y="102" text-anchor="middle" font-size="8" fill="#7E9B86">Heat sink — aluminium fins dissipate to ambient by convection</text><text x="260" y="118" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Every 10°C rise in junction temp → flux drops, colour shifts blue, L70 life ~halves</text></svg>`,
"3.4":`<svg viewBox="0 0 520 138" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">CC vs CV DRIVER — WHEN TO USE EACH</text><rect x="8" y="18" width="242" height="110" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="129" y="36" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">Constant Current (CC)</text><text x="129" y="50" text-anchor="middle" font-size="8" fill="#7A9688">Fixed output: 350/700/1050 mA</text><text x="129" y="63" text-anchor="middle" font-size="8" fill="#2F4A3F">Single fixture applications</text><text x="129" y="76" text-anchor="middle" font-size="8" fill="#2F4A3F">Downlights · track · high-bay</text><text x="129" y="89" text-anchor="middle" font-size="8" fill="#7E9B86">Prevents thermal runaway</text><text x="129" y="102" text-anchor="middle" font-size="8" fill="#7E9B86">Consistent lumen output</text><text x="129" y="118" text-anchor="middle" font-size="8" fill="#7A9688">Most common driver type</text><rect x="270" y="18" width="242" height="110" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="391" y="36" text-anchor="middle" font-size="10" fill="#1857a0" font-weight="500">Constant Voltage (CV)</text><text x="391" y="50" text-anchor="middle" font-size="8" fill="#7A9688">Fixed output: 12V or 24V DC</text><text x="391" y="63" text-anchor="middle" font-size="8" fill="#2F4A3F">Distributed load systems</text><text x="391" y="76" text-anchor="middle" font-size="8" fill="#2F4A3F">LED strip · signage · coves</text><text x="391" y="89" text-anchor="middle" font-size="8" fill="#7A9688">Strip has own resistors</text><text x="391" y="102" text-anchor="middle" font-size="8" fill="#7A9688">Layout flexibility</text><text x="391" y="118" text-anchor="middle" font-size="8" fill="#7A9688">Less efficient than CC</text></svg>`,
"3.5":`<svg viewBox="0 0 520 138" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">DIMMING PROTOCOL COMPARISON</text><rect x="8" y="18" width="118" height="112" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="67" y="34" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">0–10V</text><text x="67" y="48" text-anchor="middle" font-size="8" fill="#7A9688">1–10V = dim range</text><text x="67" y="61" text-anchor="middle" font-size="8" fill="#7A9688">0V = lamp off</text><text x="67" y="74" text-anchor="middle" font-size="8" fill="#7A9688">Separate wire</text><text x="67" y="87" text-anchor="middle" font-size="8" fill="#cc3344">No feedback</text><text x="67" y="100" text-anchor="middle" font-size="8" fill="#cc3344">Zone only</text><text x="67" y="113" text-anchor="middle" font-size="8" fill="#7E9B86">Simple/cheap</text><rect x="136" y="18" width="118" height="112" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="195" y="34" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">DALI-2</text><text x="195" y="48" text-anchor="middle" font-size="8" fill="#7A9688">IEC 62386</text><text x="195" y="61" text-anchor="middle" font-size="8" fill="#2F4A3F">64 devices/bus</text><text x="195" y="74" text-anchor="middle" font-size="8" fill="#7E9B86">Individual address</text><text x="195" y="87" text-anchor="middle" font-size="8" fill="#7E9B86">Bidirectional</text><text x="195" y="100" text-anchor="middle" font-size="8" fill="#7E9B86">Scene memory</text><text x="195" y="113" text-anchor="middle" font-size="8" fill="#7E9B86">Fault reporting</text><rect x="264" y="18" width="118" height="112" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="323" y="34" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">PWM</text><text x="323" y="48" text-anchor="middle" font-size="8" fill="#7A9688">Duty-cycle switch</text><text x="323" y="61" text-anchor="middle" font-size="8" fill="#2F4A3F">High freq (1kHz+)</text><text x="323" y="74" text-anchor="middle" font-size="8" fill="#7E9B86">Stable colour</text><text x="323" y="87" text-anchor="middle" font-size="8" fill="#cc3344">Low freq = flicker</text><text x="323" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Theatrical/retail</text><text x="323" y="113" text-anchor="middle" font-size="8" fill="#7A9688">TM-30/WELL metric</text><rect x="392" y="18" width="120" height="112" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="452" y="34" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Triac/Phase</text><text x="452" y="48" text-anchor="middle" font-size="8" fill="#7A9688">Wallbox dimmer</text><text x="452" y="61" text-anchor="middle" font-size="8" fill="#2F4A3F">Easy retrofit</text><text x="452" y="74" text-anchor="middle" font-size="8" fill="#cc3344">Driver compat.</text><text x="452" y="87" text-anchor="middle" font-size="8" fill="#cc3344">test required</text><text x="452" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Residential</text><text x="452" y="113" text-anchor="middle" font-size="8" fill="#7A9688">common</text></svg>`,
"3.6":`<svg viewBox="0 0 520 128" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">POWER FACTOR &amp; THD — WHY THEY MATTER</text><rect x="8" y="18" width="242" height="96" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="34" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Power Factor (PF)</text><text x="129" y="49" text-anchor="middle" font-size="8" fill="#7A9688">PF = Real power (W) ÷ Apparent (VA)</text><text x="129" y="63" text-anchor="middle" font-size="8" fill="#7A9688">PF 1.0 = ideal (resistive load)</text><text x="129" y="77" text-anchor="middle" font-size="8" fill="#cc3344">PF 0.7 = 43% extra current drawn</text><text x="129" y="91" text-anchor="middle" font-size="8" fill="#7E9B86">Commercial spec: PF ≥ 0.90</text><text x="129" y="105" text-anchor="middle" font-size="8" fill="#7E9B86">DLC QPL requires PF ≥ 0.90</text><rect x="270" y="18" width="242" height="96" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="391" y="34" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Total Harmonic Distortion</text><text x="391" y="49" text-anchor="middle" font-size="8" fill="#7A9688">Deviation from pure 60 Hz sine</text><text x="391" y="63" text-anchor="middle" font-size="8" fill="#cc3344">3rd harmonics add in neutral wire</text><text x="391" y="77" text-anchor="middle" font-size="8" fill="#cc3344">Can overheat neutral conductor</text><text x="391" y="91" text-anchor="middle" font-size="8" fill="#7E9B86">Specify THD &lt; 20%</text><text x="391" y="105" text-anchor="middle" font-size="8" fill="#7E9B86">Premium: THD &lt; 10%</text><text x="260" y="122" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Specify PF ≥ 0.90 and THD &lt; 20% for all commercial LED installations</text></svg>`
,"3.7":`<svg viewBox="0 0 520 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  <rect x="4" y="4" width="252" height="192" rx="10" fill="#e8f5ee" stroke="#7E9B86" stroke-width="0.8"/>
  <text x="130" y="24" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="700">LEED</text>
  <text x="130" y="37" text-anchor="middle" font-size="8" fill="#7E9B86">Environmental performance</text>
  <rect x="16" y="46" width="108" height="52" rx="6" fill="#fff" stroke="#7E9B86" stroke-width="0.5"/>
  <text x="70" y="62" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="600">Energy credits</text>
  <text x="70" y="75" text-anchor="middle" font-size="8" fill="#7A9688">LPD reduction</text>
  <text x="70" y="87" text-anchor="middle" font-size="8" fill="#7A9688">ASHRAE 90.1</text>
  <rect x="136" y="46" width="108" height="52" rx="6" fill="#fff" stroke="#7E9B86" stroke-width="0.5"/>
  <text x="190" y="62" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="600">Controls</text>
  <text x="190" y="75" text-anchor="middle" font-size="8" fill="#7A9688">Daylight harvest</text>
  <text x="190" y="87" text-anchor="middle" font-size="8" fill="#7A9688">Occupancy sensors</text>
  <rect x="16" y="106" width="108" height="52" rx="6" fill="#fff" stroke="#7E9B86" stroke-width="0.5"/>
  <text x="70" y="122" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="600">EQ credits</text>
  <text x="70" y="135" text-anchor="middle" font-size="8" fill="#7A9688">Daylight + views</text>
  <text x="70" y="147" text-anchor="middle" font-size="8" fill="#7A9688">Glare control</text>
  <rect x="136" y="106" width="108" height="52" rx="6" fill="#fff" stroke="#7E9B86" stroke-width="0.5"/>
  <text x="190" y="122" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="600">Quality</text>
  <text x="190" y="135" text-anchor="middle" font-size="8" fill="#7A9688">CRI ≥ 90, R9 ≥ 50</text>
  <text x="190" y="147" text-anchor="middle" font-size="8" fill="#7A9688">LEED v4.1 EQ</text>
  <rect x="16" y="166" width="228" height="22" rx="5" fill="#7E9B86" opacity="0.12"/>
  <text x="130" y="181" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="600">Metric: watts per sq ft — light as energy</text>
  <text x="266" y="104" text-anchor="middle" font-size="11" fill="#7A9688" font-weight="700">vs</text>
  <rect x="264" y="4" width="252" height="192" rx="10" fill="#f3eef8" stroke="#7a3a9a" stroke-width="0.8"/>
  <text x="390" y="24" text-anchor="middle" font-size="10" fill="#7a3a9a" font-weight="700">WELL</text>
  <text x="390" y="37" text-anchor="middle" font-size="8" fill="#7a3a9a">Human health + wellness</text>
  <rect x="276" y="46" width="108" height="52" rx="6" fill="#fff" stroke="#7a3a9a" stroke-width="0.5"/>
  <text x="330" y="62" text-anchor="middle" font-size="9" fill="#7a3a9a" font-weight="600">Circadian</text>
  <text x="330" y="75" text-anchor="middle" font-size="8" fill="#7A9688">≥200 EML target</text>
  <text x="330" y="87" text-anchor="middle" font-size="8" fill="#7A9688">Tunable white</text>
  <rect x="396" y="46" width="108" height="52" rx="6" fill="#fff" stroke="#7a3a9a" stroke-width="0.5"/>
  <text x="450" y="62" text-anchor="middle" font-size="9" fill="#7a3a9a" font-weight="600">Visual comfort</text>
  <text x="450" y="75" text-anchor="middle" font-size="8" fill="#7A9688">UGR glare limits</text>
  <text x="450" y="87" text-anchor="middle" font-size="8" fill="#7A9688">Luminance ratios</text>
  <rect x="276" y="106" width="108" height="52" rx="6" fill="#fff" stroke="#7a3a9a" stroke-width="0.5"/>
  <text x="330" y="122" text-anchor="middle" font-size="9" fill="#7a3a9a" font-weight="600">Light quality</text>
  <text x="330" y="135" text-anchor="middle" font-size="8" fill="#7A9688">Flicker reduction</text>
  <text x="330" y="147" text-anchor="middle" font-size="8" fill="#7A9688">CRI ≥ 90, R9 ≥ 50</text>
  <rect x="396" y="106" width="108" height="52" rx="6" fill="#fff" stroke="#7a3a9a" stroke-width="0.5"/>
  <text x="450" y="122" text-anchor="middle" font-size="9" fill="#7a3a9a" font-weight="600">Daylight</text>
  <text x="450" y="135" text-anchor="middle" font-size="8" fill="#7A9688">sDA / ASE metrics</text>
  <text x="450" y="147" text-anchor="middle" font-size="8" fill="#7A9688">View quality</text>
...
,"4.3":`<svg viewBox="0 0 520 140" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LM-79 AND LM-80 AND TM-21</text><rect x="8" y="20" width="156" height="110" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width="1"/><text x="86" y="38" text-anchor="middle" font-size="10" fill="#C65A3A" font-family="monospace" font-weight="500">LM-79</text><text x="86" y="53" text-anchor="middle" font-size="9" fill="#2F4A3F">Complete luminaire</text><text x="86" y="66" text-anchor="middle" font-size="8" fill="#7A9688">Lumens, efficacy, CCT</text><text x="86" y="79" text-anchor="middle" font-size="8" fill="#7A9688">CRI, distribution</text><text x="86" y="121" text-anchor="middle" font-size="8" fill="#C65A3A" font-weight="500">Required for DLC</text><rect x="182" y="20" width="156" height="110" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width="1"/><text x="260" y="38" text-anchor="middle" font-size="10" fill="#1857a0" font-family="monospace" font-weight="500">LM-80</text><text x="260" y="53" text-anchor="middle" font-size="9" fill="#2F4A3F">LED package only</text><text x="260" y="66" text-anchor="middle" font-size="8" fill="#7A9688">Lumen maintenance</text><text x="260" y="79" text-anchor="middle" font-size="8" fill="#7A9688">3 temps over 6000 hrs</text><text x="260" y="121" text-anchor="middle" font-size="8" fill="#1857a0" font-weight="500">NOT full luminaire</text><rect x="356" y="20" width="156" height="110" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width="1"/><text x="434" y="38" text-anchor="middle" font-size="10" fill="#7E9B86" font-family="monospace" font-weight="500">TM-21</text><text x="434" y="53" text-anchor="middle" font-size="9" fill="#2F4A3F">Lifetime projection</text><text x="434" y="66" text-anchor="middle" font-size="8" fill="#7A9688">Extrapolates LM-80 data</text><text x="434" y="79" text-anchor="middle" font-size="8" fill="#7A9688">Projects L70 and L80</text><text x="434" y="92" text-anchor="middle" font-size="8" fill="#cc3344" font-weight="500">Max equals 6x LM-80 hrs</text></svg>`
,"4.4":`<svg viewBox="0 0 520 148" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">INVERSE-SQUARE LAW</text><circle cx="58" cy="74" r="12" fill="#FFD700" opacity=".45" stroke="#C65A3A" stroke-width="1"/><text x="58" y="78" text-anchor="middle" font-size="8" fill="#C65A3A" font-weight="500">I cd</text><line x1="70" y1="74" x2="176" y2="74" stroke="#C65A3A" stroke-width="1.2"/><line x1="70" y1="74" x2="176" y2="50" stroke="#C65A3A" stroke-width=".7" opacity=".5"/><line x1="70" y1="74" x2="176" y2="98" stroke="#C65A3A" stroke-width=".7" opacity=".5"/><line x1="70" y1="74" x2="316" y2="74" stroke="#C65A3A" stroke-width=".8" opacity=".45"/><rect x="174" y="44" width="6" height="60" rx="2" fill="#1857a0" opacity=".7"/><text x="177" y="118" text-anchor="middle" font-size="8" fill="#1857a0">d</text><text x="177" y="130" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">E=I/d2</text><rect x="314" y="28" width="6" height="92" rx="2" fill="#7E9B86" opacity=".55"/><text x="317" y="130" text-anchor="middle" font-size="8" fill="#7E9B86">2d</text><text x="317" y="142" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">E=quarter</text><rect x="366" y="28" width="146" height="92" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="439" y="48" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">E = I divided by d2</text><text x="439" y="64" text-anchor="middle" font-size="8" fill="#7A9688">E = illuminance lux</text><text x="439" y="77" text-anchor="middle" font-size="8" fill="#7A9688">I = intensity candelas</text><text x="439" y="90" text-anchor="middle" font-size="8" fill="#7A9688">d = distance metres</text><text x="439" y="107" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">2d gives E div 4</text><text x="439" y="119" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">3d gives E div 9</text></svg>`
,"4.5":`<svg viewBox="0 0 520 148" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">COSINE LAW</text><circle cx="126" cy="36" r="11" fill="#FFD700" opacity=".45" stroke="#C65A3A" stroke-width="1"/><text x="126" y="40" text-anchor="middle" font-size="8" fill="#C65A3A">I cd</text><rect x="194" y="16" width="6" height="78" rx="2" fill="#7E9B86" opacity=".7"/><line x1="137" y1="36" x2="194" y2="36" stroke="#7E9B86" stroke-width="1.2"/><text x="165" y="32" text-anchor="middle" font-size="8" fill="#7E9B86">d</text><text x="197" y="108" text-anchor="middle" font-size="8" fill="#7E9B86">theta=0 cos=1.0</text><text x="197" y="120" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">E=I/d2</text><line x1="137" y1="36" x2="334" y2="90" stroke="#1857a0" stroke-width="1.2"/><line x1="318" y1="62" x2="350" y2="116" stroke="#1857a0" stroke-width="4" stroke-linecap="round" opacity=".65"/><text x="356" y="90" font-size="8" fill="#1857a0">theta=45</text><text x="356" y="102" font-size="8" fill="#1857a0">cos=0.707</text><text x="356" y="116" font-size="9" fill="#1857a0" font-weight="500">E=0.71 I/d2</text><rect x="8" y="100" width="290" height="44" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="16" y="116" font-size="8" fill="#7A9688">cos 0=1.000  cos 30=0.866  cos 45=0.707</text><text x="16" y="130" font-size="8" fill="#7A9688">cos 60=0.500  cos 75=0.259  cos 90=0</text></svg>`
,"4.6":`<svg viewBox="0 0 520 148" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LUMEN METHOD ZONAL CAVITY</text><rect x="8" y="20" width="504" height="28" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="32" text-anchor="middle" font-size="10" fill="#C65A3A" font-weight="500">E avg = N times Phi times CU times LLF divided by A</text><text x="260" y="43" text-anchor="middle" font-size="8" fill="#7A9688">For design: N = E times A divided by Phi times CU times LLF</text><rect x="8" y="56" width="116" height="82" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="66" y="73" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">N and Phi and A</text><text x="66" y="87" text-anchor="middle" font-size="8" fill="#7A9688">N = luminaires</text><text x="66" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Phi = lamp lumens</text><text x="66" y="113" text-anchor="middle" font-size="8" fill="#7A9688">A = floor area</text><rect x="132" y="56" width="116" height="82" rx="4" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="190" y="73" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">CU</text><text x="190" y="87" text-anchor="middle" font-size="8" fill="#7A9688">From photometric table</text><text x="190" y="100" text-anchor="middle" font-size="8" fill="#7E9B86">RCR = 5h(L+W) div LW</text><text x="190" y="113" text-anchor="middle" font-size="8" fill="#7A9688">plus reflectances</text><rect x="256" y="56" width="116" height="82" rx="4" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="314" y="73" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">LLF</text><text x="314" y="87" text-anchor="middle" font-size="8" fill="#7A9688">= LLD times LDD</text><text x="314" y="100" text-anchor="middle" font-size="8" fill="#1857a0">LED clean space</text><text x="314" y="113" text-anchor="middle" font-size="8" fill="#1857a0">0.80 to 0.90</text><rect x="380" y="56" width="132" height="82" rx="4" fill="#f3eef8" stroke="#7a3a9a" stroke-width=".8"/><text x="446" y="73" text-anchor="middle" font-size="9" fill="#7a3a9a" font-weight="500">Dark walls impact</text><text x="446" y="87" text-anchor="middle" font-size="8" fill="#7A9688">High RCR = lower CU</text><text x="446" y="100" text-anchor="middle" font-size="8" fill="#7a3a9a">30pct walls needs 44pct</text><text x="446" y="113" text-anchor="middle" font-size="8" fill="#7a3a9a">more fixtures than 50pct</text></svg>`
,"5.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">WHY WE CONTROL: ENERGY WELLBEING COMPLIANCE</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="85" y="38" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">Energy</text><text x="85" y="53" text-anchor="middle" font-size="9" fill="#7A9688">30-50 pct more savings</text><text x="85" y="67" text-anchor="middle" font-size="9" fill="#7A9688">beyond efficient sources</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">ASHRAE 90.1 and Title 24</text><rect x="182" y="20" width="154" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="259" y="38" text-anchor="middle" font-size="10" fill="#1857a0" font-weight="500">Wellbeing</text><text x="259" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Individual dimming</text><text x="259" y="67" text-anchor="middle" font-size="9" fill="#7A9688">Tunable white CCT</text><text x="259" y="81" text-anchor="middle" font-size="9" fill="#7A9688">Circadian support</text><text x="259" y="95" text-anchor="middle" font-size="8" fill="#1857a0">WELL v2 and LEED</text><rect x="356" y="20" width="154" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="433" y="38" text-anchor="middle" font-size="10" fill="#C65A3A" font-weight="500">Compliance</text><text x="433" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Occupancy sensing</text><text x="433" y="67" text-anchor="middle" font-size="9" fill="#7A9688">Daylight controls</text><text x="433" y="81" text-anchor="middle" font-size="9" fill="#7A9688">Manual dimming</text><text x="433" y="95" text-anchor="middle" font-size="8" fill="#C65A3A">ASHRAE 90.1 IECC</text></svg>`
,"5.2":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">OCCUPANCY vs VACANCY AND SENSOR TYPES</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="37" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Occupancy sensor</text><text x="85" y="52" text-anchor="middle" font-size="8" fill="#7A9688">Auto ON and Auto OFF</text><text x="85" y="66" text-anchor="middle" font-size="8" fill="#7A9688">Convenient</text><text x="85" y="92" text-anchor="middle" font-size="9" fill="#C65A3A">Less saving</text><rect x="172" y="20" width="154" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="249" y="37" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Vacancy sensor</text><text x="249" y="52" text-anchor="middle" font-size="8" fill="#7A9688">Manual ON and Auto OFF</text><text x="249" y="66" text-anchor="middle" font-size="8" fill="#7E9B86">5-10 pct more savings</text><text x="249" y="80" text-anchor="middle" font-size="8" fill="#7E9B86">ASHRAE 90.1 required</text><text x="249" y="92" text-anchor="middle" font-size="8" fill="#7E9B86">offices meetings classrooms</text><rect x="336" y="20" width="176" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="424" y="37" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Technologies</text><text x="424" y="52" text-anchor="middle" font-size="8" fill="#7A9688">PIR: heat and large motion</text><text x="424" y="66" text-anchor="middle" font-size="8" fill="#7A9688">Ultrasonic: fine motion</text><text x="424" y="80" text-anchor="middle" font-size="8" fill="#7E9B86">Dual-tech: both must agree</text><text x="424" y="92" text-anchor="middle" font-size="8" fill="#7E9B86">Best for offices</text></svg>`
,"5.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">DAYLIGHT HARVESTING: CLOSED AND OPEN LOOP</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">Closed-loop</text><text x="129" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Measures daylight plus electric</text><text x="129" y="67" text-anchor="middle" font-size="9" fill="#7A9688">at the work plane</text><text x="129" y="81" text-anchor="middle" font-size="9" fill="#7E9B86">Most accurate</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">ASHRAE 90.1 requires Cx</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="391" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Open-loop</text><text x="391" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Measures incoming</text><text x="391" y="67" text-anchor="middle" font-size="9" fill="#7A9688">daylight only and estimates</text><text x="391" y="81" text-anchor="middle" font-size="9" fill="#7A9688">Simpler install</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#cc3344">Less precise and drifts</text><text x="260" y="122" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">LEED v4.1: sDA 55 pct or more and ASE 10 pct or less</text></svg>`
,"5.4":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LEED v4.1 AND WELL v2 LIGHTING REQUIREMENTS</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">LEED v4.1 EQ</text><text x="129" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Individual controls 90pct of</text><text x="129" y="67" text-anchor="middle" font-size="9" fill="#7A9688">occupant positions is 1 pt</text><text x="129" y="81" text-anchor="middle" font-size="9" fill="#7E9B86">CRI 90 or more and R9 50 or more</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">sDA 55pct or more for credit</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="10" fill="#1857a0" font-weight="500">WELL v2 Light</text><text x="391" y="53" text-anchor="middle" font-size="9" fill="#7A9688">200 EML or more morning</text><text x="391" y="67" text-anchor="middle" font-size="9" fill="#7A9688">UGR 22 or less occupied</text><text x="391" y="81" text-anchor="middle" font-size="9" fill="#1857a0">Flicker limits per L03</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#1857a0">CRI 90 and R9 50 per L05</text></svg>`
,"5.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">S/P RATIO AND DALI-2 PROTOCOL</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">S/P Ratio</text><text x="129" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Scotopic divided by Photopic</text><text x="129" y="67" text-anchor="middle" font-size="9" fill="#7A9688">Cool LED S/P above 1.5</text><text x="129" y="81" text-anchor="middle" font-size="9" fill="#7E9B86">20-40 pct brighter appearance</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">under mesopic conditions</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">DALI-2 IEC 62386</text><text x="391" y="53" text-anchor="middle" font-size="9" fill="#7A9688">64 devices per bus</text><text x="391" y="67" text-anchor="middle" font-size="9" fill="#7E9B86">Individual addressing</text><text x="391" y="81" text-anchor="middle" font-size="9" fill="#7E9B86">Scene memory at driver</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">Fault reporting and BACnet</text></svg>`
,"5.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">BACnet AND IoT AND PoE LIGHTING</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">BACnet</text><text x="85" y="53" text-anchor="middle" font-size="9" fill="#7A9688">ASHRAE 135 open protocol</text><text x="85" y="67" text-anchor="middle" font-size="9" fill="#2F4A3F">Lighting plus HVAC unified</text><text x="85" y="81" text-anchor="middle" font-size="9" fill="#2F4A3F">Demand response</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Emergency override</text><rect x="182" y="20" width="154" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="259" y="38" text-anchor="middle" font-size="10" fill="#1857a0" font-weight="500">IoT Lighting</text><text x="259" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Each fixture is a data node</text><text x="259" y="67" text-anchor="middle" font-size="9" fill="#1857a0">Occupancy analytics</text><text x="259" y="81" text-anchor="middle" font-size="9" fill="#1857a0">Predictive maintenance</text><text x="259" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Continuous commissioning</text><rect x="356" y="20" width="154" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="433" y="38" text-anchor="middle" font-size="10" fill="#7E9B86" font-weight="500">PoE Lighting</text><text x="433" y="53" text-anchor="middle" font-size="9" fill="#7A9688">Power plus data Cat cable</text><text x="433" y="67" text-anchor="middle" font-size="9" fill="#7E9B86">90W per port 802.3bt</text><text x="433" y="81" text-anchor="middle" font-size="9" fill="#7E9B86">Fixture-level metering</text><text x="433" y="95" text-anchor="middle" font-size="8" fill="#7A9688">100m segment limit</text></svg>`
,"6.1":`<svg viewBox="0 0 520 148" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">DOWNLIGHT: APERTURE, BEAM AND TRIM</text><rect x="160" y="18" width="200" height="14" rx="3" fill="#DDD0C0" stroke="#7A9688" stroke-width=".8"/><text x="260" y="29" text-anchor="middle" font-size="8" fill="#7A9688">Ceiling plane</text><rect x="200" y="32" width="120" height="28" rx="4" fill="#FAF5F0" stroke="#C65A3A" stroke-width="1"/><text x="260" y="51" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Aperture</text><line x1="260" y1="60" x2="178" y2="128" stroke="#C65A3A" stroke-width="1" stroke-dasharray="4,3"/><line x1="260" y1="60" x2="342" y2="128" stroke="#C65A3A" stroke-width="1" stroke-dasharray="4,3"/><line x1="178" y1="128" x2="342" y2="128" stroke="#DDD0C0" stroke-width=".8"/><path d="M 260,60 A 28,28 0 0,1 278,70" fill="none" stroke="#C65A3A" stroke-width="1"/><text x="284" y="70" font-size="8" fill="#C65A3A">beam angle</text><rect x="8" y="72" width="148" height="68" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="82" y="90" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Aperture sizes</text><text x="82" y="104" text-anchor="middle" font-size="8" fill="#7A9688">2 in accent</text><text x="82" y="117" text-anchor="middle" font-size="8" fill="#7A9688">4 in task</text><text x="82" y="130" text-anchor="middle" font-size="8" fill="#7A9688">6 in high-output</text><text x="260" y="142" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Diameter = 2 x height x tan(beam / 2)</text></svg>`
,"6.2":`<svg viewBox="0 0 520 138" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">IES DISTRIBUTION TYPES I THROUGH V</text><rect x="8" y="20" width="86" height="108" rx="4" fill="#FAF5F0" stroke="#C65A3A" stroke-width=".8"/><text x="51" y="37" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Type I</text><text x="51" y="51" text-anchor="middle" font-size="8" fill="#7A9688">Two-way</text><text x="51" y="65" text-anchor="middle" font-size="8" fill="#7A9688">along road</text><text x="51" y="79" text-anchor="middle" font-size="8" fill="#2F4A3F">Walkways</text><text x="51" y="93" text-anchor="middle" font-size="8" fill="#7A9688">narrow paths</text><rect x="102" y="20" width="86" height="108" rx="4" fill="#FAF5F0" stroke="#1857a0" stroke-width=".8"/><text x="145" y="37" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Type II</text><text x="145" y="51" text-anchor="middle" font-size="8" fill="#7A9688">Short lateral</text><text x="145" y="65" text-anchor="middle" font-size="8" fill="#7A9688">reach</text><text x="145" y="79" text-anchor="middle" font-size="8" fill="#2F4A3F">Side-of-road</text><text x="145" y="93" text-anchor="middle" font-size="8" fill="#7A9688">driveways</text><rect x="196" y="20" width="86" height="108" rx="4" fill="#e8f5ee" stroke="#7E9B86" stroke-width="1"/><text x="239" y="37" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Type III</text><text x="239" y="51" text-anchor="middle" font-size="8" fill="#7A9688">Medium lateral</text><text x="239" y="65" text-anchor="middle" font-size="8" fill="#7E9B86">Most common</text><text x="239" y="79" text-anchor="middle" font-size="8" fill="#7E9B86">Parking lots</text><text x="239" y="93" text-anchor="middle" font-size="8" fill="#7E9B86">roadways</text><rect x="290" y="20" width="86" height="108" rx="4" fill="#FAF5F0" stroke="#7a3a9a" stroke-width=".8"/><text x="333" y="37" text-anchor="middle" font-size="9" fill="#7a3a9a" font-weight="500">Type IV</text><text x="333" y="51" text-anchor="middle" font-size="8" fill="#7A9688">Forward throw</text><text x="333" y="65" text-anchor="middle" font-size="8" fill="#7A9688">asymmetric</text><text x="333" y="79" text-anchor="middle" font-size="8" fill="#2F4A3F">Perimeter</text><text x="333" y="93" text-anchor="middle" font-size="8" fill="#7a3a9a">wall mount</text><rect x="384" y="20" width="128" height="108" rx="4" fill="#e8eef8" stroke="#1857a0" stroke-width="1"/><text x="448" y="37" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Type V</text><text x="448" y="51" text-anchor="middle" font-size="8" fill="#7A9688">Circular</text><text x="448" y="65" text-anchor="middle" font-size="8" fill="#7A9688">symmetric</text><text x="448" y="79" text-anchor="middle" font-size="8" fill="#2F4A3F">Pole-mounted</text><text x="448" y="93" text-anchor="middle" font-size="8" fill="#1857a0">centre of area</text><text x="448" y="107" text-anchor="middle" font-size="8" fill="#1857a0">parking lots</text></svg>`
,"6.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">SPACING CRITERION AND UNIFORMITY</text><rect x="8" y="20" width="504" height="24" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="30" text-anchor="middle" font-size="10" fill="#C65A3A" font-weight="500">SC = Max spacing / Mounting height</text><text x="260" y="40" text-anchor="middle" font-size="8" fill="#7A9688">SC 1.3 at 3 m mounting height means max spacing = 3.9 m</text><rect x="8" y="52" width="242" height="68" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="69" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Uniformity Emin / Eavg</text><text x="129" y="83" text-anchor="middle" font-size="8" fill="#7E9B86">1:3 recommended offices</text><text x="129" y="97" text-anchor="middle" font-size="8" fill="#7E9B86">1:5 acceptable general</text><text x="129" y="111" text-anchor="middle" font-size="8" fill="#7A9688">Verify with point-by-point calc</text><rect x="260" y="52" width="252" height="68" rx="4" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="386" y="69" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">SC typical values</text><text x="386" y="83" text-anchor="middle" font-size="8" fill="#7A9688">Narrow spot: SC 0.8 to 1.0</text><text x="386" y="97" text-anchor="middle" font-size="8" fill="#7A9688">Medium: SC 1.0 to 1.3</text><text x="386" y="111" text-anchor="middle" font-size="8" fill="#7E9B86">Bat-wing: SC 1.3 to 1.5</text></svg>`
...
,"7.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">EXIT SIGNS AND EGRESS LIGHTING CODE</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Exit sign requirements</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Visible from any point on egress path</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Max viewing distance 100 ft (6-in letters)</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Battery or 2-circuit wiring</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#C65A3A">IBC and NFPA 101 required</text><rect x="260" y="20" width="252" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="386" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Egress lighting path</text><text x="386" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Corridors, stairs, exits</text><text x="386" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">1 fc at floor (NFPA 101)</text><text x="386" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Instant on at power loss</text><text x="386" y="95" text-anchor="middle" font-size="8" fill="#7A9688">LED now dominant</text></svg>`
,"7.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">EXTERIOR LIGHTING CODE COMPLIANCE</text><rect x="8" y="20" width="504" height="26" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="31" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">ASHRAE 90.1 Exterior LPD allowances by application</text><text x="260" y="41" text-anchor="middle" font-size="8" fill="#7A9688">Parking lots: 0.15 W/sqft max. Walkways: 1.0 W/linft max. Building facades: 1.0 W/sqft max</text><rect x="8" y="54" width="242" height="68" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="72" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Lighting zones LZ0-LZ4</text><text x="129" y="86" text-anchor="middle" font-size="8" fill="#7A9688">LZ0 = natural dark wilderness</text><text x="129" y="100" text-anchor="middle" font-size="8" fill="#7A9688">LZ4 = high-density commercial</text><text x="129" y="114" text-anchor="middle" font-size="8" fill="#7A9688">Sets max luminaire flux</text><rect x="260" y="54" width="252" height="68" rx="4" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="386" y="72" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Curfew provisions</text><text x="386" y="86" text-anchor="middle" font-size="8" fill="#1857a0">Dim or off after 11pm</text><text x="386" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Reduces energy and sky glow</text><text x="386" y="114" text-anchor="middle" font-size="8" fill="#7A9688">IECC and many local codes</text></svg>`
,"8.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">HIGH-BAY VS LOW-BAY MOUNTING</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Low-bay</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Mounting 4.5-7.5 m (15-25 ft)</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Wide-distribution optic</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Retail back-of-house</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Light manufacturing</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">High-bay</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Mounting 7.5 m and above (25 ft+)</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Narrow-to-medium optic</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Warehouses, manufacturing</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">Sports halls, arenas</text></svg>`
,"8.2":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">IP, IK AND NEMA RATINGS</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">IP rating</text><text x="85" y="53" text-anchor="middle" font-size="8" fill="#7A9688">IP XX: dust + water</text><text x="85" y="67" text-anchor="middle" font-size="8" fill="#2F4A3F">IP65 = dust-tight</text><text x="85" y="81" text-anchor="middle" font-size="8" fill="#2F4A3F">+ low-pressure jet</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Wet locations min</text><rect x="172" y="20" width="154" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="249" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">IK rating</text><text x="249" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Impact protection</text><text x="249" y="67" text-anchor="middle" font-size="8" fill="#1857a0">IK08 = 5 J impact</text><text x="249" y="81" text-anchor="middle" font-size="8" fill="#1857a0">IK10 = 20 J impact</text><text x="249" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Industrial/sports</text><rect x="336" y="20" width="176" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="424" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">NEMA enclosure</text><text x="424" y="53" text-anchor="middle" font-size="8" fill="#7A9688">NEMA 3R = rain</text><text x="424" y="67" text-anchor="middle" font-size="8" fill="#7A9688">NEMA 4 = hose-down</text><text x="424" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">NEMA 4X = corrosive</text><text x="424" y="95" text-anchor="middle" font-size="8" fill="#7A9688">North American std</text></svg>`
,"8.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">HAZARDOUS LOCATIONS: CLASS AND DIVISION</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Class I</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Flammable gases or vapours</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Petroleum, paint, chemicals</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Div 1: hazard present normally</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Div 2: hazard only if fault</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Class II and III</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Class II: combustible dust</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Grain, flour, coal dust</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Class III: ignitable fibres</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Textiles, woodworking</text></svg>`
,"8.4":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">CIRCADIAN RHYTHMS AND ipRGC LIGHTING</text><rect x="8" y="20" width="504" height="26" rx="4" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="260" y="31" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">ipRGC melanopsin pathway: light input at 480 nm drives SCN circadian clock</text><text x="260" y="41" text-anchor="middle" font-size="8" fill="#7A9688">High EML morning = alertness and cortisol. Low EML evening = melatonin release for sleep onset</text><rect x="8" y="54" width="242" height="68" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="72" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Morning protocol</text><text x="129" y="86" text-anchor="middle" font-size="8" fill="#7E9B86">200 EML or more at eye</text><text x="129" y="100" text-anchor="middle" font-size="8" fill="#7E9B86">CCT 4000-6500K preferred</text><text x="129" y="114" text-anchor="middle" font-size="8" fill="#7A9688">Supports alertness onset</text><rect x="260" y="54" width="252" height="68" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="386" y="72" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Evening protocol</text><text x="386" y="86" text-anchor="middle" font-size="8" fill="#C65A3A">Low EML, CCT 2700K or less</text><text x="386" y="100" text-anchor="middle" font-size="8" fill="#7A9688">Allows melatonin production</text><text x="386" y="114" text-anchor="middle" font-size="8" fill="#7A9688">Tunable white system</text></svg>`
,"8.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">WELL v2 LIGHT CONCEPT REQUIREMENTS</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Preconditions (mandatory)</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">L01: Light design documentation</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#1857a0">L02: Min illuminance + UGR 22 or less</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">L03: Flicker limits per spec</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">All must be met for certification</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Optimizations (scored)</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7E9B86">L04: 200 EML or more at eye AM</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">L05: CRI 90 and R9 50 or more</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">L06: sDA 55% and ASE 10% or less</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Each earns additional points</text></svg>`
,"8.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">INDUSTRIAL LIGHTING: IES RP-7 RECOMMENDATIONS</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Rough service</text><text x="85" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Warehouse storage</text><text x="85" y="67" text-anchor="middle" font-size="8" fill="#7A9688">200-300 lux</text><text x="85" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Ra 60-70 acceptable</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7A9688">IP65 minimum</text><rect x="172" y="20" width="154" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="249" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Manufacturing</text><text x="249" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Assembly, machining</text><text x="249" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">500-1000 lux task</text><text x="249" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Ra 80 minimum</text><text x="249" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Glare control critical</text><rect x="336" y="20" width="176" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="424" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Critical inspection</text><text x="424" y="53" text-anchor="middle" font-size="8" fill="#7A9688">QC, colour matching</text><text x="424" y="67" text-anchor="middle" font-size="8" fill="#C65A3A">1000-2000 lux</text><text x="424" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Ra 90 minimum</text><text x="424" y="95" text-anchor="middle" font-size="8" fill="#C65A3A">D65 evaluation source</text></svg>`
,"9.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">ASHRAE 90.1 LPD ALLOWANCES</text><rect x="8" y="20" width="504" height="22" rx="3" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="35" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Interior LPD limits W/sqft, Building Area Method, 90.1-2019</text><rect x="8" y="48" width="116" height="70" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="66" y="65" text-anchor="middle" font-size="8" fill="#2F4A3F" font-weight="500">Office</text><text x="66" y="79" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">0.82 W/sqft</text><rect x="132" y="48" width="116" height="70" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="190" y="65" text-anchor="middle" font-size="8" fill="#2F4A3F" font-weight="500">Retail</text><text x="190" y="79" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">1.26 W/sqft</text><rect x="256" y="48" width="116" height="70" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="314" y="65" text-anchor="middle" font-size="8" fill="#2F4A3F" font-weight="500">Warehouse</text><text x="314" y="79" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">0.60 W/sqft</text><rect x="380" y="48" width="132" height="70" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="446" y="65" text-anchor="middle" font-size="8" fill="#2F4A3F" font-weight="500">Healthcare</text><text x="446" y="79" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">1.05 W/sqft</text></svg>`
,"9.2":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">TITLE 24 PART 6: CALIFORNIA ENERGY CODE</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Prescriptive path</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Space-by-space LPA limits</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">W/sqft by space type</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Mandatory controls</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Occupancy and daylighting</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Performance path</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Whole-building energy model</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7A9688">TDV energy budget</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">More design flexibility</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Requires certified analyst</text></svg>`
,"9.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">sDA AND ASE DAYLIGHT METRICS</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">sDA</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Pct floor area at 300 lux or more</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">for 50 pct of occupied hours</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">sDA 55 pct = LEED 1 pt</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#1857a0">sDA 75 pct = LEED 2 pts</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">ASE</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Pct floor area at 1000 lux or more</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7A9688">for 250 or more occupied hours</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">ASE 10 pct max for LEED</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#C65A3A">Limits glare and heat gain</text></svg>`
,"9.4":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">RoHS, EPD AND HPD DECLARATIONS</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">RoHS</text><text x="85" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Restricts Pb, Hg, Cd, Cr6+</text><text x="85" y="67" text-anchor="middle" font-size="8" fill="#7A9688">in electronic equipment</text><text x="85" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Mandatory EU and UK</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Global baseline standard</text><rect x="172" y="20" width="154" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="249" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">EPD</text><text x="249" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Environmental Product Decl.</text><text x="249" y="67" text-anchor="middle" font-size="8" fill="#7A9688">ISO 14025 lifecycle</text><text x="249" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">GWP carbon footprint</text><text x="249" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">LEED MR credit</text><rect x="336" y="20" width="176" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="424" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">HPD</text><text x="424" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Health Product Declaration</text><text x="424" y="67" text-anchor="middle" font-size="8" fill="#7A9688">All ingredients 100 ppm or more</text><text x="424" y="81" text-anchor="middle" font-size="8" fill="#1857a0">Material health disclosure</text><text x="424" y="95" text-anchor="middle" font-size="8" fill="#1857a0">LEED MR credit</text></svg>`
,"9.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LIFE-CYCLE COST ANALYSIS</text><rect x="8" y="20" width="504" height="24" rx="4" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="260" y="31" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">LCC = First cost + PV(energy) + PV(maintenance) + PV(disposal)</text><text x="260" y="41" text-anchor="middle" font-size="8" fill="#7A9688">Present value over 10-20 year analysis period</text><rect x="8" y="52" width="116" height="68" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="66" y="70" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">First cost</text><text x="66" y="84" text-anchor="middle" font-size="8" fill="#7A9688">Luminaires, install</text><text x="66" y="98" text-anchor="middle" font-size="8" fill="#7A9688">Controls, commissioning</text><rect x="132" y="52" width="116" height="68" rx="4" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="190" y="70" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Energy</text><text x="190" y="84" text-anchor="middle" font-size="8" fill="#7E9B86">kWh x utility rate</text><text x="190" y="98" text-anchor="middle" font-size="8" fill="#7E9B86">Largest LCC component</text><rect x="256" y="52" width="116" height="68" rx="4" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="314" y="70" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Maintenance</text><text x="314" y="84" text-anchor="middle" font-size="8" fill="#1857a0">Lamp replacements</text><text x="314" y="98" text-anchor="middle" font-size="8" fill="#1857a0">Cleaning and labour</text><rect x="380" y="52" width="132" height="68" rx="4" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="446" y="70" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Rebates</text><text x="446" y="84" text-anchor="middle" font-size="8" fill="#7A9688">Utility incentives</text><text x="446" y="98" text-anchor="middle" font-size="8" fill="#7A9688">Reduce first cost 30-70 pct</text></svg>`
,"9.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LEED v4.1 LIGHTING CREDITS SUMMARY</text><rect x="8" y="20" width="504" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">LEED v4.1 BD+C Lighting-related credits</text><text x="260" y="54" text-anchor="middle" font-size="8" fill="#7E9B86">EQ Interior Lighting: individual controls 90 pct and quality metrics CRI 90 R9 50</text><text x="260" y="68" text-anchor="middle" font-size="8" fill="#7E9B86">Daylight: sDA 55 pct = 1 pt, sDA 75 pct = 2 pts with ASE 10 pct max</text><text x="260" y="82" text-anchor="middle" font-size="8" fill="#1857a0">EA Energy: LPD reduction contributes to energy savings percentage credits</text><text x="260" y="96" text-anchor="middle" font-size="8" fill="#C65A3A">MR Materials: EPD and HPD for luminaires count toward disclosure credits</text><text x="260" y="110" text-anchor="middle" font-size="8" fill="#7A9688">SS Light Pollution: full cutoff, U0, warm CCT below 3000K</text></svg>`
,"10.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">DESIGN PHASES: PROGRAMMING AND SCHEMATIC</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Programming and Pre-design</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Owner Project Requirements</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">CCT, Ra, budget, certifications</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Controls and aesthetic intent</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#C65A3A">Engage LD at this phase</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Schematic Design (SD)</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Concept luminaire families</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Preliminary photometric layouts</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Code compliance strategy</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Owner presentation and approval</text></svg>`
,"10.2":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">DESIGN DEVELOPMENT: SCHEDULE AND CALCULATIONS</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">DD Fixture Schedule</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Type, manufacturer, wattage</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">CCT, CRI, dimming, IP, mount</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">LM-79 and DLC referenced</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Equal-or-better criteria defined</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">DD Calculations</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">AGi32 or DIALux with actual IES</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Verify illuminance, uniformity</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">LPD, UGR, EML against spec</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">LEED and code compliance check</text></svg>`
,"10.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">MOCK-UPS AND FIELD REVIEW</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Why mock-ups matter</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Confirm CCT and CRI in context</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Verify dimming performance</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Reveal glare problems early</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Owner sign-off before purchase</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Mock-up protocol</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Full-size section, all finalists</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Measure actual illuminance</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Document and photograph</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Owner sign-off on record</text></svg>`
,"10.4":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">MEP AND STRUCTURAL COORDINATION</text><rect x="8" y="20" width="504" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Common coordination conflicts</text><text x="260" y="54" text-anchor="middle" font-size="8" fill="#C65A3A">Structural: downlights conflict with beams, joists, or post-tensioned slabs</text><text x="260" y="68" text-anchor="middle" font-size="8" fill="#1857a0">Mechanical: luminaires blocked by ductwork, diffusers, or sprinkler heads</text><text x="260" y="82" text-anchor="middle" font-size="8" fill="#7E9B86">Ceiling grid: luminaire module must align with 2x2 or 2x4 grid</text><text x="260" y="96" text-anchor="middle" font-size="8" fill="#7A9688">Electrical: circuit loading, neutral sizing for THD, AFCI compatibility</text><text x="260" y="110" text-anchor="middle" font-size="8" fill="#7A9688">BIM clash detection before permit drawings issued</text></svg>`
,"10.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">CONTROLS SEQUENCE OF OPERATIONS</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Controls documentation</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Sequence of operations narrative</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Control zone drawings</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">Scene levels and emergency modes</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Programming reference document</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">ASHRAE 90.1 mandatory controls</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Automatic shutoff required</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Occupancy sensing per Table 9.4.1</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Daylight zones: photosensors</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">Demand response capability</text></svg>`
,"10.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">CONSTRUCTION DOCUMENTS: CD SET COMPONENTS</text><rect x="8" y="20" width="504" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">A complete lighting CD set</text><text x="260" y="54" text-anchor="middle" font-size="8" fill="#7E9B86">RCP: fixture locations, types, circuiting, switching assignments</text><text x="260" y="68" text-anchor="middle" font-size="8" fill="#7E9B86">Fixture schedule: type tag, full desc, wattage, LM-79 ref, DLC listing</text><text x="260" y="82" text-anchor="middle" font-size="8" fill="#1857a0">Controls drawings: zone plan, sequences of operation, riser</text><text x="260" y="96" text-anchor="middle" font-size="8" fill="#1857a0">Photometric calcs: illuminance plans, LPD summary, LEED compliance</text><text x="260" y="110" text-anchor="middle" font-size="8" fill="#7A9688">Details: section details for coves, slots, and wall-wash reveals</text></svg>`
,"11.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">SUBMITTALS AND SUBSTITUTION REVIEW</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Required submittal data</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Product data sheets</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#1857a0">LM-79 test report full copy</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">DLC QPL listing confirmation</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">IES photometric file</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Substitution review</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Compare against spec criteria</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Wattage, CCT, CRI, R9</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Lumen output, efficacy</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Dimming protocol, IP, mounting</text></svg>`
,"11.2":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">CONSTRUCTION ADMINISTRATION PHASES</text><rect x="8" y="20" width="154" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="85" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Bidding</text><text x="85" y="53" text-anchor="middle" font-size="8" fill="#7A9688">RFI response</text><text x="85" y="67" text-anchor="middle" font-size="8" fill="#7A9688">Addenda issued</text><text x="85" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Substitution requests</text><text x="85" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Bid levelling support</text><rect x="172" y="20" width="154" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="249" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Construction</text><text x="249" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Submittal review</text><text x="249" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Site visits</text><text x="249" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">RFI responses</text><text x="249" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Change order review</text><rect x="336" y="20" width="176" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="424" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Closeout</text><text x="424" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Punch list</text><text x="424" y="67" text-anchor="middle" font-size="8" fill="#C65A3A">Commissioning</text><text x="424" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">As-built drawings</text><text x="424" y="95" text-anchor="middle" font-size="8" fill="#7A9688">O and M manuals</text></svg>`
,"11.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">PUNCH LIST AND SUBSTANTIAL COMPLETION</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Punch list items typical</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Wrong luminaire type installed</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#cc3344">Non-approved substitution used</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Fixture not level or plumb</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Dimming not functioning</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Substantial completion</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Building is usable</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Certificate issued</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Warranty period begins</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Punch list remains open</text></svg>`
,"11.4":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">LIGHTING COMMISSIONING PROCESS</text><rect x="8" y="20" width="504" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Commissioning sequence</text><text x="260" y="54" text-anchor="middle" font-size="8" fill="#7E9B86">1. Verify all luminaires installed per RCP and fixture schedule</text><text x="260" y="68" text-anchor="middle" font-size="8" fill="#7E9B86">2. Verify controls zones wired per zone plan</text><text x="260" y="82" text-anchor="middle" font-size="8" fill="#1857a0">3. Program sequences of operation per narrative</text><text x="260" y="96" text-anchor="middle" font-size="8" fill="#1857a0">4. Verify occupancy sensors, photosensors, and scene setpoints</text><text x="260" y="110" text-anchor="middle" font-size="8" fill="#C65A3A">5. Measure and document actual illuminance against specification</text></svg>`
,"11.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">POST-OCCUPANCY EVALUATION</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">POE measures</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Occupant satisfaction surveys</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#1857a0">Actual energy use vs model</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">Illuminance measurements</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Controls performance logs</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Common POE findings</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Controls reprogrammed by FM</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#cc3344">Sensors mis-aimed or failed</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#cc3344">Energy savings not achieved</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7E9B86">Informs next project design</text></svg>`
,"11.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">MAINTENANCE PLANNING AND LUMEN DEPRECIATION</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Maintenance cycle planning</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">LLD: lumen depreciation over life</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7A9688">LDD: dirt on optical surfaces</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">Combined = Light Loss Factor</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">LLF drives fixture count</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Group relamping strategy</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Replace all at interval</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">vs spot replacement</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">LED: longer intervals</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Driver failure monitoring</text></svg>`
,"12.1":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">OFFICE AND WORKPLACE LIGHTING</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Workplace standards</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">300-500 lux task plane</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">UGR 19 or less</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Uniformity 1:3</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Individual dimming LEED</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Activity-based working</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Focus zones: 500 lux</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Collaboration: 300 lux</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Lounge: 100-200 lux</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Tunable white circadian</text></svg>`
,"12.2":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">RETAIL AND HOSPITALITY LIGHTING</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Retail</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Ambient 300-500 lux</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#C65A3A">Accent 3-5x ambient</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">CRI 90 and R9 50 min</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Adjustable track for change</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#fff5ee" stroke="#C65A3A" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Hospitality and restaurant</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">50-100 lux ambient</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#C65A3A">5:1 to 10:1 contrast ratio</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#C65A3A">2700-3000K warm CCT</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Dimming to 1 pct or below</text></svg>`
,"12.3":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">HEALTHCARE AND EDUCATION LIGHTING</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Healthcare</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Patient room: 100-300 lux</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#1857a0">Exam: 1000 lux task</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#1857a0">Ra 90 and R9 50 min</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">UGR 19 max, lens trim</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Education</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Classroom: 300-500 lux</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">Board: 500 lux vertical</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7E9B86">Ra 80 minimum</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Daylight harvesting priority</text></svg>`
,"12.4":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">RESIDENTIAL: KITCHEN AND BATH</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#C65A3A" font-weight="500">Kitchen lighting layers</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#7A9688">General: 300 lux ceiling</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#C65A3A">Task: 500 lux countertop</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Under-cabinet for prep</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">CCT 2700-3000K</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8eef8" stroke="#1857a0" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#1857a0" font-weight="500">Bath and vanity</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7A9688">Side-lit mirror preferred</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#1857a0">Ra 90 for grooming</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#1857a0">500 lux at face height</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">IP44 minimum wet zones</text></svg>`
,"12.5":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">MUSEUM AND GALLERY LIGHTING</text><rect x="8" y="20" width="242" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="129" y="38" text-anchor="middle" font-size="9" fill="#2F4A3F" font-weight="500">Conservation requirements</text><text x="129" y="53" text-anchor="middle" font-size="8" fill="#C65A3A">Annual lux-hours limit</text><text x="129" y="67" text-anchor="middle" font-size="8" fill="#C65A3A">UV below 75 microwatts/lm</text><text x="129" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Sensitive: 50 lux max</text><text x="129" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Robust: 200 lux max</text><rect x="270" y="20" width="242" height="98" rx="5" fill="#e8f5ee" stroke="#7E9B86" stroke-width=".8"/><text x="391" y="38" text-anchor="middle" font-size="9" fill="#7E9B86" font-weight="500">Display lighting spec</text><text x="391" y="53" text-anchor="middle" font-size="8" fill="#7E9B86">Ra 95 or above</text><text x="391" y="67" text-anchor="middle" font-size="8" fill="#7E9B86">R9 50 or above</text><text x="391" y="81" text-anchor="middle" font-size="8" fill="#7A9688">Adjustable track accent</text><text x="391" y="95" text-anchor="middle" font-size="8" fill="#7A9688">Dimming for lux-hour control</text></svg>`
,"12.6":`<svg viewBox="0 0 520 128" style="width:100%;height:auto" xmlns="http://www.w3.org/2000/svg"><text x="260" y="12" text-anchor="middle" font-size="8" fill="#7A9688" font-family="monospace" letter-spacing=".1em">NCQLP EXAM INTEGRATED REVIEW</text><rect x="8" y="20" width="504" height="98" rx="5" fill="#FAF5F0" stroke="#DDD0C0" stroke-width=".5"/><text x="260" y="38" text-anchor="middle" font-size="10" fill="#2F4A3F" font-weight="500">Key calculation formulas</text><text x="260" y="54" text-anchor="middle" font-size="8" fill="#C65A3A">E = I/d2 (inverse-square) and E = (I x cos theta)/d2 (cosine law)</text><text x="260" y="68" text-anchor="middle" font-size="8" fill="#7E9B86">E avg = (N x Phi x CU x LLF) / A and RCR = 5h(L+W)/(LxW)</text><text x="260" y="82" text-anchor="middle" font-size="8" fill="#1857a0">SC = max spacing / mounting height and Beam diam = 2 x h x tan(beam/2)</text><text x="260" y="96" text-anchor="middle" font-size="8" fill="#7A9688">LPD = total installed watts / floor area (use system wattage, not lamp)</text><text x="260" y="110" text-anchor="middle" font-size="8" fill="#7A9688">TM-21 max projection = 6x LM-80 test duration</text></svg>`
};
const LC_DATA = {
...
"3.7":{body:["<strong>LEED (Leadership in Energy and Environmental Design)</strong> is the world's most widely adopted green building certification system, developed by the U.S. Green Building Council. Its primary purpose is to improve environmental performance by reducing energy consumption, lowering carbon emissions, conserving resources, and creating healthier indoor environments. LEED evaluates buildings across multiple categories including Energy & Atmosphere, Indoor Environmental Quality, Water Efficiency, Materials & Resources, Sustainable Sites, and Innovation.","From a lighting perspective, LEED focuses heavily on energy efficiency and environmental impact. Credits are commonly earned through the use of high-efficiency luminaires, reduced lighting power density (LPD), daylight harvesting controls, occupancy sensors, and advanced lighting control systems. Designers must demonstrate that lighting systems provide required illumination while minimizing energy consumption and operational costs throughout the building lifecycle.","LEED also addresses occupant experience through Indoor Environmental Quality (EQ) credits. Lighting strategies that improve access to daylight, preserve exterior views, reduce glare, and enhance visual comfort contribute to healthier and more productive spaces. While human comfort is important within LEED, the system primarily evaluates lighting as a component of overall building sustainability and environmental performance.","The <strong>WELL Building Standard</strong>, administered by the International WELL Building Institute, is a performance-based certification system focused entirely on human health, wellness, and occupant experience. Unlike LEED, which emphasizes environmental sustainability, WELL evaluates how buildings affect the people who occupy them. The standard addresses categories such as Air, Water, Nourishment, Movement, Thermal Comfort, Sound, Mind, Community, and Light.","Lighting is one of the most significant components of WELL because of its direct influence on human physiology and behavior. WELL promotes lighting designs that support circadian rhythms, improve alertness during the day, enhance sleep quality at night, and reduce visual discomfort. Requirements often include daylight access, equivalent melanopic lux targets, glare control, appropriate luminance ratios, and lighting systems that align with natural biological cycles.","WELL also places strong emphasis on the quality of electric light. Metrics such as color rendering, flicker reduction, tunable white lighting, visual comfort, and user control are frequently considered. The objective is not simply to illuminate a space efficiently, but to create environments that actively support health, cognitive performance, mood, and overall well-being. In this way, WELL evaluates lighting as a human-centered design tool rather than solely as a building system."],lp:["LEED = environmental performance. Key lighting credits: LPD reduction, daylight harvesting, occupancy sensors, EQ credits (daylight, views, glare). Metric: watts per sq ft.","WELL = human health. Key lighting requirements: ≥200 EML melanopic lux, circadian support, flicker reduction, tunable white, CRI ≥ 90, R9 ≥ 50. Metric: melanopic lux (EML).","Critical distinction: LEED measures light as a building energy system. WELL measures light as a human health tool. A project can pursue both simultaneously — they are complementary, not competing."],tts:"Lesson 3.7. LEED and WELL. LEED is the U.S. Green Building Council's environmental certification. For lighting, LEED credits target reduced lighting power density, daylight harvesting, and occupancy sensors. WELL is the International WELL Building Institute's health-focused standard. WELL requires melanopic lux of 200 or more, circadian-supportive lighting, flicker reduction, and high colour rendering. The key distinction: LEED measures light as energy. WELL measures light as health. Both can be pursued on the same project."}
,"3.8":{body:["The commercial lighting market encompasses a wide range of <strong>LED package types</strong>, each engineered for specific optical, thermal, and application requirements. Understanding the differences between these technologies is essential for specifying the correct light source for any project. The most fundamental distinction is between <strong>Discrete LEDs</strong> — individual single-chip packages used in indicators, signage, and low-power applications — and <strong>COB (Chip-on-Board)</strong> technology, which mounts multiple LED dies directly onto a single substrate to create a high-density, uniform light-emitting surface. COB LEDs deliver superior optical control and color consistency, making them the preferred choice for downlights, spotlights, track heads, and high-output architectural luminaires.","<strong>SMD (Surface-Mount Device)</strong> LEDs represent the most widely used LED technology in modern lighting. Available in standardized package sizes including 2835, 3030, and 5050, SMD LEDs offer an excellent balance of efficacy, cost, and manufacturing efficiency across linear fixtures, troffers, panel lights, and residential luminaires. <strong>LED Tape Light</strong> extends the SMD format onto flexible printed circuit boards, enabling continuous linear illumination in curved surfaces, coves, millwork, and architectural details. <strong>High-Power LEDs</strong> operate at elevated currents with robust thermal management systems and are engineered for applications demanding intense illumination over long throw distances — including sports lighting, floodlights, street lighting, and industrial high-bays.","Emerging and specialized LED formats expand the technology's reach into precision and display applications. <strong>Mini LEDs</strong> enable extremely high-density arrays for advanced backlighting and display systems, while <strong>MicroLEDs</strong> function as microscopic self-emissive pixels for premium displays, AR, and VR systems. <strong>Filament LEDs</strong> replicate the incandescent aesthetic using transparent substrates populated with LED chips, and are widely specified in hospitality and decorative contexts. <strong>RGB and RGBW LEDs</strong> combine multiple color channels for dynamic color mixing and human-centric lighting applications. For non-visible spectrum needs, <strong>UV LEDs</strong> (200–400 nm) serve disinfection, curing, and forensic applications, while <strong>IR LEDs</strong> (700–1,000 nm) are critical components in occupancy sensors, security cameras, and machine vision systems. <strong>OLEDs</strong> complete the spectrum by producing soft, diffuse surface-area illumination from organic semiconductor materials, enabling thin, lightweight, and flexible luminaire designs with exceptional visual comfort."],lp:["Key LED package types for NCQLP: Discrete LED = single chip, indicators/signage. COB = multiple dies on substrate, uniform surface, downlights/spotlights. SMD = most common, packages 2835/3030/5050, linear/troffers/panels. Tape light = flexible PCB, coves/millwork. High-power LED = high current, sports/floods/street/high-bay.","Specialized types: Mini LED = high-density arrays, display backlighting. MicroLED = microscopic self-emissive pixels, premium displays/AR/VR. Filament LED = incandescent aesthetic, hospitality/decorative. RGB/RGBW = color mixing, architectural/entertainment. UV LED = 200-400nm, disinfection/curing. IR LED = 700-1000nm, sensors/security. OLED = organic surface emitter, thin/flexible, diffuse illumination.","Specification tip: COB for optical precision and color consistency. SMD for cost-effective commercial applications. High-power for long throw and industrial. Filament for aesthetic match. RGBW adds white emitter to RGB for better efficacy and CRI than RGB alone."],tts:"Lesson 3.8. LED package types. Discrete LEDs are single-chip components for indicators and signage. COB, or Chip-on-Board, mounts multiple dies on a substrate for uniform high-output illumination — ideal for downlights, spotlights, and track heads. SMD LEDs are the most common commercial format, available in 2835, 3030, and 5050 packages for linear fixtures, troffers, and panels. Tape light uses flexible PCBs for coves and millwork. High-power LEDs operate at elevated current for sports, flood, street, and high-bay applications. Specialized types include Mini LED and MicroLED for displays, Filament LED for decorative aesthetics, RGB and RGBW for color-changing systems, UV LEDs for disinfection and curing, IR LEDs for sensors and security cameras, and OLEDs for thin flexible surface-area illumination."}
...
,"7.1":{body:["Outdoor luminaire selection depends critically on understanding <strong>IES light distribution types</strong> — a classification system developed by the Illuminating Engineering Society to describe how area luminaires project light across horizontal and vertical planes. Selecting the wrong distribution type leads to dark zones, overlapping hotspots, light trespass onto adjacent properties, and wasted energy. The five distribution types — I through V — each correspond to specific mounting conditions and application geometries, and specifiers must match them precisely to the site.","<strong>Type I</strong> produces a narrow, elongated bilateral pattern ideal for luminaires mounted at the centerline of a pathway. The illuminated width roughly equals the mounting height, making it well-suited for sidewalks, pedestrian corridors, and narrow landscape walks. <strong>Type II</strong> widens the distribution to approximately 1.5 times the mounting height and is positioned at the edge of the area being lit — appropriate for wide pathways, alleys, and secondary roadways where the pole is offset from the center. <strong>Type III</strong> extends reach to roughly 2.75 times the mounting height, projecting light forward and outward from a side-mounted position. This is the workhorse distribution for roadway lighting, general parking lots, and large landscaped areas.","<strong>Type IV</strong>, sometimes called forward throw or asymmetric distribution, also covers 2.75 times the mounting height but pushes virtually all light forward with minimal spill behind the fixture. It is the preferred choice for building perimeters, wall-mount applications, and parking lot perimeter poles where light trespass behind the fixture must be controlled. <strong>Type V</strong> distributes light equally in all directions — either in a circular or square pattern — making it the correct choice for large commercial parking areas, plazas, and any space requiring uniform omnidirectional coverage from a center-mounted pole. Understanding these five types, their mounting geometries, and their typical applications is a foundational NCQLP competency for exterior lighting specification."],lp:["Five IES outdoor distribution types: Type I — narrow bilateral, centerline mounting, width ≈ mounting height. Type II — edge mounting, width up to 1.5× MH. Type III — side mounting, width up to 2.75× MH, roadways and parking. Type IV — asymmetric forward throw, 2.75× MH, building perimeters. Type V — omnidirectional circular/square, large open areas.","Mounting position determines type selection: centerline → Type I; edge of path → Type II; side of road → Type III; wall or perimeter → Type IV; center of large space → Type V. Mismatch between distribution type and mounting position causes dark zones and light trespass.","NCQLP exam focus: know which distribution type applies to each application. Parking lot centers = Type V. Roadway poles at curb = Type III. Building wall packs = Type IV. Pedestrian path centerline = Type I. Wide alley edge = Type II."],tts:"Lesson 7.1. IES Light Distribution Types for Outdoor Applications. The Illuminating Engineering Society classifies outdoor luminaire distributions as Type I through Type V. Type I is narrow and bilateral, used at the centerline of walkways, with a spread equal to the mounting height. Type II widens to one and a half times the mounting height and mounts at the edge of a path or roadway. Type III spreads two point seven five times the mounting height from a side-mounted position — the standard for roadways and parking lots. Type IV is the asymmetric forward throw distribution, also covering two point seven five times the mounting height, but pushing light forward with minimal spillback — used on building perimeters and wall packs. Type V is omnidirectional, distributing light evenly in all directions — the correct choice for large commercial parking areas and plazas. Matching distribution type to mounting geometry is essential to eliminate dark zones, prevent light trespass, and pass the NCQLP exam."}
...
const MODULE_SHARE_COPY = {
  "01": `Module 01 complete — Light & the Visual Environment. Electromagnetic spectrum, photopic vs scotopic vision, the inverse square law, footcandles vs lux, luminous efficacy, and the fundamentals that underpin every lighting calculation. 💡 The LC exam starts here. So did I → lightingmasterlc.com`,

  "02": `Module 02 complete — Light Sources & Lamps. Incandescent, fluorescent, HID, and LED compared. Lamp life, lumen depreciation, CCT, CRI, TM-30 Rf and Rg, and how to select the right source for any application. 🔆 Know your sources. Pass your exam → lightingmasterlc.com`,
  ...
  "04": `Module 04 complete — Lighting Controls & Systems. DALI, 0-10V dimming, occupancy sensors, BACnet, Title 24 mandatory controls, and ASHRAE 90.1 compliance. 🎛️ Smart buildings need smart lighting professionals. Become one → lightingmasterlc.com`,

  "05": `Module 05 complete — Photometry & Luminaire Performance. IES files, candela distribution curves, coefficient of utilization, zonal cavity method, luminance ratios, UGR and VCP glare metrics. 📐 The math behind great lighting. Master it → lightingmasterlc.com`,

  "06": `Module 06 complete — Interior Lighting Design. Illuminance targets, layered lighting, accent ratios, color rendering in retail and healthcare, museum conservation limits, and hospitality atmosphere design. 🏛️ Great spaces don't happen by accident. Neither does passing the LC exam → lightingmasterlc.com`,

  "07": `Module 07 complete — Exterior, Emergency & Codes. BUG ratings, light trespass, IESNA RP-8 roadway standards, IES distribution Types I–V, NFPA 101 emergency lighting (1fc, 90 min, 10 sec), and Title 24 outdoor LPD. 🌃 From streets to exit signs — if it's lit, it's on the exam → lightingmasterlc.com`,

  "08": `Module 08 complete — Energy Codes & Standards. ASHRAE 90.1 LPD tables, building area vs space-by-space methods, Title 24, IECC compliance paths, and power allowance calculations. ⚙️ Energy codes aren't going away. Neither are lighting professionals who know them → lightingmasterlc.com`,

  "09": `Module 09 complete — Daylighting & Human-Centric Lighting. sDA, ASE, daylight autonomy, melanopic lux, circadian entrainment, tunable white, WELL L01–L09, and daylight harvesting controls. 🌅 Light affects how people feel, sleep, and perform. This module shows you why → lightingmasterlc.com`,

  "10": `Module 10 complete — Lighting Economics & Project Management. Life-cycle cost analysis, simple payback vs ROI, utility rebates, lighting audits, retrofit scoping, and group relamping strategies. 💼 The best lighting designers speak the language of money too → lightingmasterlc.com`,

  "11": `Module 11 complete — Sustainability & Green Building. LEED v4.1 lighting credits, WELL Building Standard, DLC QPL, EnergyStar, LCA for luminaires, and third-party certification documentation. 🌿 Sustainable design is not a trend. It's the standard. Stay ahead of it → lightingmasterlc.com`,

  "12": `Module 12 complete — Lighting Design Practice & Documentation. Design process, photometric reports, lighting schedules, point-by-point calculations, commissioning checklists, submittals, and post-occupancy evaluation. 🏆 12 modules down. One exam between you and LC. You've got this → lightingmasterlc.com`,
}
...
const LC_AUDIO = {
  ...
  "9.3": "https://res.cloudinary.com/dreuglb2j/video/upload/v1781454027/Lesson_903_ptiilf.mp4",
  "9.4": "https://res.cloudinary.com/dreuglb2j/video/upload/v1781454023/Lesson_904_kqas7o.mp4",
