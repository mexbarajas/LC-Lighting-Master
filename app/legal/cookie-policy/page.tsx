      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <div className="prose prose-sm max-w-none space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-700">Essential Cookies: These cookies are necessary for operation of the Platform. Examples include: Login authentication, Session management, Security verification, Fraud prevention, User account access. Without these cookies, portions of the Platform may not function properly.</p>
            <p className="text-gray-700 mt-3">Functional Cookies: Functional cookies help remember user preferences such as: Language settings, Display preferences, User choices, Platform settings.</p>
            <p className="text-gray-700 mt-3">Analytics Cookies: Analytics cookies help us understand: Visitor behavior, Website performance, Traffic sources, Content effectiveness. We currently use Google Analytics. Analytics data may include: Device information, Browser information, Pages visited, Time spent on pages, General geographic information.</p>
            <p className="text-gray-700 mt-3">Marketing Cookies: Marketing cookies may be used to: Measure campaign performance, Deliver relevant communications, Understand user interests, Improve promotional efforts. These cookies may be set by us or trusted third-party providers.</p>
          </div>
